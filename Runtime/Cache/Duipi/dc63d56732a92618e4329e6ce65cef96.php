...
<div class="layout980">
	<div class="groups-left">
		<h2 class="gr-title1"><a><b>云购圈子</b></a></h2>
		<div class="gr-guild">
			<b>在这里可以做什么?</b>
			<p class="gray01">在这里你可以找到与自己兴致相投的云友，随意申请加入任何你感兴趣的圈子，了解云购所发生的“重大事件”，参与到他们的行列之中，一起探论夺宝神奇，看看他们是如何夺宝的，一起分享交流探讨！来！一起加入他们的行列中吧！</p>
		</div>
		<div class="groups-list clearfix">
			<ul>
                        <?php if(is_array($quanzi)): foreach($quanzi as $key=>$v): ?><li>
					<div class="groups-img"><a href="/group/show/id/<?php echo ($v['id']); ?>" class="fl-img">
					<?php if(!$v['img']): ?><img src="/Public/uploads/quanzi/prmimg.jpg" title="<?php echo ($v['title']); ?>" border="0" alt="">
					<?php else: ?>
					<img src="/Public/uploads/<?php echo ($v['img']); ?>" title="<?php echo ($v['title']); ?>" border="0" alt=""><?php endif; ?>
					</a></div>
					<div class="groups-info">
						<p class="groups-name"><a href="/group/show/id/<?php echo ($v['id']); ?>" title="<?php echo ($v['title']); ?>" class="blue"><?php echo ($v['title']); ?></a></p>
