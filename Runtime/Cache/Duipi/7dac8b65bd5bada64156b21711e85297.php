            ...
            <form method="post" action="">
                ...
                <table width="100%"  cellspacing="0" cellpadding="0">
                    <tr style="background-color:#FFe;height:50px;">
                        ...
                        <td>
                            <a target="_blank" href="/goods/items/goodsId/<?php echo $shopinfo['id'];?>"><b>第(<font color="red"><?php echo $shopinfo['qishu']; ?></font>)期  <?php echo $shopinfo['title']; ?></b></a>
                            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="brand" name="brand" class="wid100">                	
                                ...
                                <?php foreach($pinpaiList as $pinpai): if($shopinfo['brandid']!=$pinpai['id']){ ?>
                                            ...
                                            <b>提示：</b> 卡密格式<br>
                                                111-aaa<br>222-bbb<br>333-ccc<br>其中111为卡号,aaa为该卡的密码,222为卡号,bbb为该卡的密码,333为卡号,ccc为该卡的密码
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img src="/Public/uploads/<?php echo ($shopinfo['thumb']); ?>" style="border:1px solid #eee; padding:1px; width:50px; height:50px;">
                                                                        <input type="text" id="imagetext" value="<?php echo ($shopinfo['thumb']); ?>" name="thumb" class="input-text wid300">
                                                                            <input type="button" class="button"
                                                                                   onClick="GetUploadify('<?php echo C("URL_DOMAIN");?>', 'uploadify', '缩略图上传', 'image', 'shopimg', 1, 500000, 'imagetext')" 
                                                                                   value="上传图片"/>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><fieldset class="uploadpicarr">
                                                                                        ...
                                                                                        <ul id="uppicarr" class="upload-img-list">                    
                                                                                            ...
                                                                                            <li rel="<?php echo $pic; ?>"><input class="input-text" type="text" name="uppicarr[]" value="<?php echo $pic; ?>"><a href="javascript:void(0);" onClick="ClearPicArr('<?php echo $pic; ?>', '<?php echo C("URL_DOMAIN");?>')">删除</a></li>
                                                                                            <?php endforeach; ?>  
                                                                                        </ul>
                                                                                    </fieldset>
                                                                                </td>           
