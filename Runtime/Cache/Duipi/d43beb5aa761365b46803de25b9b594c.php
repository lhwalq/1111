    ...
    <body>
        ...
        <div class="table-list con-tab lr10" id="con-tab">
            ...
            <div name='con-tabv' class="con-tabv">
				...
				<input type="hidden" name="type" value = <?php echo ($catetype); ?>>
                                            ...
                                            <td>           
                                                <input type="text" id="imagetext" name="thumb" class="input-text wid300">
                                                    <input type="button" class="button"
                                                           onClick="GetUploadify('<?php echo C("URL_DOMAIN");?>', 'uploadify', '栏目图片上传', 'image', 'cateimg', 1, 500000, 'imagetext')" 
                                                           value="上传图片"/>
                                            </td>
                                        </tr>
                                        <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="margin:10px;">
                                                                                        <select name="info[template]">
                                                                                            <?php  if($htmlarr=indexTemplate('/single_web\.(.*)\.dwt/i')){ foreach($htmlarr as $html){ ?>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr id="catdir_tr">
                                                                                        ...
                                                                                        <td><input type="text" name="info[url]" class="input-text wid300">
                                                                                                ...
                                                                                                <script type="text/javascript" src="/Public/plugin/style/global/js/GgTab.js"></script>
                                                                                                <script type="text/javascript">
                                                                                                       Gg.Tab({i:"li con-tabk ~on", o:"div con-tabv", events:"click", num:1});
                                                                                                       function upImage(){
                                                                                                       return document.getElementById('thumb').click();
                                                                                                       }
                                                                                                       <?php if ($catetype == 'def'){ ?>
                                                                                                               function checkform(){
            ...
            editurl['imageManager'] = '/tools/imagemanager';
                                                                                                ...
                                                                                                <script type="text/javascript">
                                                                                                    ...
                                                                                                    window.UEDITOR_CONFIG.initialFrameHeight = 450;</script>
