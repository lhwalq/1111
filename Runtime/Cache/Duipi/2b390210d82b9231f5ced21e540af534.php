...
<div class="wrap" id="loadingPicBlock">
	...
	<ul class="item" id="ulGoodsList">
			...
			<div class="gl_buybtn">
				<div class="go_buy">
					<a href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" title="立即云购" class="go_Shopping fl">立即云购</a>
					<a href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" title="加入购物车" class="go_cart fr">加入购物车</a>
				</div>
			</div>
	...
	<?php else: ?>
	<div class="NoConMsg"><span>未找到有关“<em class="orange"><?php echo ($search); ?></em>”的商品</span></div><?php endif; ?>
</div>
