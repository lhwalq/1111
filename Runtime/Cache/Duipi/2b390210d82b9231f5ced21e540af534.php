...
<!-- 导航   end  --> 
<link rel="stylesheet" type="text/css" href="/Public/piyungou/css/GoodsList.css"/>
 
<div class="wrap" id="loadingPicBlock">
	<div id="current" class="list_Curtit">
		<h1 class="fl"><?php echo (L("web_search_goods")); ?>－"<?php echo ($search); ?>"</h1>
		<span id="spTotalCount">(<?php echo (L("web_shaidan_gong")); ?><em class="orange"><?php echo ($list); ?></em><?php echo (L("web_search_jian_goods")); ?>)</span>
	</div>
        <?php if($yyslist != null ): ?><div class="listContent">
	<ul class="item" id="ulGoodsList">
            <?php if(is_array($yyslist)): foreach($yyslist as $key=>$shop): ?><li class="goods-iten" >
			<div class="pic">
				<a href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" target="_blank" title="<?php echo ($shop['title']); ?> "><img alt="<?php echo ($shop['title']); ?>" src="/Public/uploads/<?php echo ($shop['thumb']); ?>"></a>
				<p name="buyCount" style="display:none;"></p>
			</div>
			<p class="name">
				<a href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" target="_blank" title="<?php echo ($shop['title']); ?> "><?php echo ($shop['title']); ?></a>
			</p>
			<p class="money"><?php echo (L("web_glist_value")); ?>：<span class="rmbgray"><?php echo ($shop['money']); ?></span></p>
			<div class="Progress-bar">
				<p ><span style="width:<?php echo R('base/width',array($shop['canyurenshu'],$shop['zongrenshu'],213));?>px;"></span></p>
				<ul class="Pro-bar-li">
					<li class="P-bar01"><em><?php echo ($shop['canyurenshu']); ?></em><?php echo (L("web_lottery_person_al")); ?></li>
					<li class="P-bar02"><em><?php echo ($shop['zongrenshu']); ?></em><?php echo (L("web_user_total_num")); ?></li>
					<li class="P-bar03"><em><?php echo ($shop['zongrenshu']-$shop['canyurenshu']); ?></em><?php echo (L("web_user_surplus_num")); ?></li>
				</ul>
			</div>
			<div class="gl_buybtn">
				<div class="go_buy">
					<a href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" title=<?php echo (L("web_user_go_cloud")); ?> class="go_Shopping fl"><?php echo (L("web_user_go_cloud")); ?></a>
					<a href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" title=<?php echo (L("web_search_add_gouwuche")); ?> class="go_cart fr"><?php echo (L("web_search_add_gouwuche")); ?></a>
				</div>
			</div>
	...
	<?php else: ?>
	<div class="NoConMsg"><span><?php echo (L("web_search_no_select")); ?>“<em class="orange"><?php echo ($search); ?></em>”<?php echo (L("web_search_goods")); ?></span></div><?php endif; ?>
</div>
