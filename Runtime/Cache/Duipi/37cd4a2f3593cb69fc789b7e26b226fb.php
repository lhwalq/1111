...
<body>
        ...
        <div class="float">
            ...
            <ul class="ui-step" style='float:right;margin-top:10px'>
                ...
                <li class="ui-step-center">
                    <div class="ui-step-line">-</div>
                    <div class="ui-step-icon">
                        <i class="ui-step-number"><?php echo (L("web_index_pay")); ?></i>
                        <span class="ui-step-text">&nbsp;</span>
                    </div>
                </li>
                <li class="ui-step-center">
                    <div class="ui-step-line">-</div>
                    <div class="ui-step-icon">
                        <i class="ui-step-number"><?php echo (L("web_index_draw")); ?></i>
                        <span class="ui-step-text">&nbsp;</span>
                    </div>
                </li>
                <li class="ui-step-end">
                    <div class="ui-step-line">-</div>
                    <div class="ui-step-icon">
                        <i class="ui-step-number"><?php echo (L("web_index_announce")); ?></i>
                        <span class="ui-step-text">&nbsp;</span>
                    </div>
                </li>
            </ul>
    ...
    <div class="shop_process">
        ...
        <div class="submitted">
            <ul class="order">
                <li class="top">
                    <span class="goods"><?php echo (L("web_lottery_goods")); ?></span>
                    <span class="name"><?php echo (L("web_cart_name")); ?></span>
                    <span class="moneys"><?php echo (L("web_glist_value")); ?></span>
                    <span class="money"><?php echo (L("web_cart_money")); ?></span>
                    <span class="num"><?php echo (L("web_cart_num")); ?></span>
                    <span class="xj"><?php echo (L("web_cart_xiaoji")); ?></span>
                    <span class="do"><?php echo (L("web_cart_chaozuo")); ?></span>
                </li>
                  <script>
                ...
                <?php if(is_array($yyslist)): foreach($yyslist as $key=>$shops): ?><li class="end" id="shoplist<?php echo ($shops['id']); ?>">
                    ...
                    <span class="name">
                        ...
                        <?php if($shops['pay_ygb'] == 1): ?><p style="color:red"><?php echo (L("web_cart_point")); ?></p><?php endif; ?>
                        <p><?php echo (L("web_lottery_all_has")); ?> <span class="color"><?php echo ($shops['zongrenshu']); ?></span><?php echo (L("web_cart_person")); ?>
                            <span class="gorenci"><?php echo ($shops['cart_shenyu']); ?></span> <?php echo (L("web_lottery_person")); ?>
                        </p>
                    </span>
                    <span class="moneys"><?php echo (L("web_lottery_mark")); echo ($shops['money']); ?></span>
                    <span class="money"><span class="color"><?php echo (L("web_lottery_mark")); ?><b><?php echo ($shops['yunjiage']); ?></b></span></span>
                    <?php if($shops['cart_shenyu']=='0'): ?><span class="num">				
                        ...
                        <p class="message" style="margin-left:12px;color:black"><?php echo (L("web_cart_goods")); ?></p>
                    </span> 
                    ...
                    <?php elseif($shops['is_choose'] == 1): ?>
                     <span class="num">				
		                    ...
		                    <p class="message" style="margin-left:12px;color:black" ><?php echo (L("web_cart_phone")); ?></p>
						</span> 
                    ...
                    <span class="do"><a href="javascript:;" onclick="delcart(<?php echo ($shops['id']); ?>)"  class="delgood"><?php echo (L("web_cart_delete")); ?></a></span>
                </li><?php endforeach; endif; ?>
                <li class="ts">
                    <p class="right"><?php echo (L("web_cart_yungou")); ?>:<?php echo (L("web_lottery_mark")); ?><span id="moenyCount"><?php echo ($MoenyCount); ?></span></p>
                </li>
            </ul>
        </div>
        <h5>
