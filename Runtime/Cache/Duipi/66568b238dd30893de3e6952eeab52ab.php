            ...
            <table width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th align="center"><a href="/order/lists/type/feijiqi">购买用户</a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a  target="_blank" href="/goods/dataserverForPc/goodsId/<?php echo ($v['shopid']); ?>">
                                第(<?php echo $v['shopqishu'];?>)期<?php echo R('base/strcut',array($v['shopname'],0,25));?></a>
                        </td>              
                        <td align="center"><?php echo $v['username'];if ($v['huiyuan']==1){echo "(机器人)";} ?></td>
                        ...
                        <td align="center"><a href="/order/get_dingdan/id/<?php echo $v['id']; ?>">详细</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
