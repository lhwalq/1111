...
<!-- 导航   end  --> 
<link rel="stylesheet" type="text/css" href="/Public/piyungou/css/css.css"/>
<link rel="stylesheet" type="text/css" href="/Public/piyungou/css/pageDialog.css"/>
<div class="layout980 clearfix"> 
<div class="sidebar">
	<div class="head"><a href="/user/uname/d/<?php echo R('Base/idjia',array($huiyuan['uid']));?>.html">  
		<img id="imgUserPhoto" src="/Public/uploads/<?php echo ($huiyuan1['img']); ?>" width="160" height="160" border="0"/>			
	</a></div>  
...
<div class="content clearfix">
	<div class="per-info">
		<ul>
			<li class="info-mane gray02">
				<b class="gray01" ><?php echo R("base/huode_user_name",array($huiyuan1,'username'));?></b>				
			</li>
			<li class="info-address"><span><a href="/user/uname/d/<?php echo R('base/idjia',array($huiyuan1['uid']));?>.html" class="blue"><s></s>/user/uname/<?php echo R('base/idjia',array($huiyuan1['uid']));?></a></span></li>
			<li class="info-intro gray02">
			
			<?php if($huiyuan1['qianming'] != null): else: ?>
			这家伙很懒，什么都没留下。<?php endif; ?>
			</li>
		</ul>
	</div>
	<div class="subnav">
	<ul>
		...
		<?php if($bb == 'uname'): ?><li class="poa-4"><a class="cur">TA的主页<s></s></a></li>
		<?php else: ?>
		<li class="poa-4"><a href="/user/uname/tab/uname/d/<?php echo R('base/idjia',array($huiyuan1['uid']));?>.html" >TA的主页<s></s></a></li><?php endif; ?>
		<?php if($bb == 'userbuy'): ?><li class="poa-4"><a class="cur">云购记录<s></s></a></li>
		<?php else: ?>
		<li class="poa-4"><a href="/user/uname/tab/userbuy/d/<?php echo R('base/idjia',array($huiyuan1['uid']));?>.html" >云购记录<s></s></a></li><?php endif; ?>
		<?php if($bb == 'userraffle'): ?><li class="poa-4"><a class="cur">获得的商品<s></s></a></li>
		<?php else: ?>
		<li class="poa-4"><a href="/user/uname/tab/userraffle/d/<?php echo R('base/idjia',array($huiyuan1['uid']));?>.html" >获得的商品<s></s></a></li><?php endif; ?>
	...
	<?php if($huiyuan1): ?><div id="divInfo0" class="New-content">


		<?php if(is_array($huiyuango)): foreach($huiyuango as $key=>$go): $jiexiao =R("BASE/huode_shop_if_jiexiao",array($go['shopid'])); if ($jiexiao['q_uid']){ $url = "dataserverForPC"; }else{ $url = "items"; } ?>
		<div class="scroll-list">
			<div class="R-tit">
				<span class="tit-name gray01">
					<?php echo R("base/huode_user_name",array($huiyuan1,'username'));?>
				</span>
				<i>在<?php echo R("base/microt",array($go['time'],"r"));?>云购了</i>
				<span class="tit blue"><a target="_blank" href="/goods/<?php echo ($url); ?>/goodsId/<?php echo ($go['shopid']); ?>.html" class="blue"><?php echo ($go['shopname']); ?></a></span>
			</div>          
			<div class="buy-com">
				<p class="buy-pic"><a target="_blank" href="/goods/<?php echo ($url); ?>/goodsId/<?php echo ($go['shopid']); ?>.html"><img src="/Public/uploads/<?php echo ($jiexiao['thumb']); ?>"></a></p>
				<div class="buy-rcon">                 	
					<p class="buy-name"><a target="_blank" rel="nofollow" href="/goods/<?php echo ($url); ?>/goodsId/<?php echo ($go['shopid']); ?>.html" class="blue">(第<?php echo ($go['shopqishu']); ?>期)<?php echo ($go['shopname']); ?></a></p>				
                   
                    
					<?php if($jiexiao['q_uid']): ?><p class="buy-money gray02">价值：<span class="money"><i class="rmb"><?php echo ($jiexiao['money']); ?></i></span></p>
					<p class="buy-code gray02">幸运云购码：<span class="orange"><?php echo ($jiexiao['q_user_code']); ?></span></p>
					<p class="buy-time gray02">揭晓时间：<?php echo (date("Y-m-d",$jiexiao['q_end_time'])); ?></p>
					<p><a target="_blank" href="/goods/<?php echo ($url); ?>/goodsId/<?php echo ($go['shopid']); ?>.html" class="button03">去看看</a></p>
					<?php else: ?>
					<p><a target="_blank" href="/goods/<?php echo ($url); ?>/goodsId/<?php echo ($go['shopid']); ?>.html" class="button03">去看看</a></p><?php endif; ?>
				</div>
			</div>
		</div><?php endforeach; endif; ?>		
	</div>
	<?php else: ?>
	<div class="New-content"><div class="tips-con"><i></i>TA还没有获得商品哦</div></div><?php endif; ?>
</div>
