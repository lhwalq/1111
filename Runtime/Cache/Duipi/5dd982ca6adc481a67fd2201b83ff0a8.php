...
<!--content left end-->
<link rel="stylesheet" type="text/css" href="/Public/piyungou/css/layout-setUp.css"/>
<script type="text/javascript">
//裁剪图片
...
$(function(){
    $('#file_upload').uploadify({
        ...
        'uploader' : '/user/userphotoup',
        'method'   : 'post',
		'buttonText' : '选择图片',
		'buttonImage': '/Public/img/upload.gif',
		'width': 94,
		'height': 27,
        'multi'    : true,
        'uploadLimit' : 5,
...
function SetImgContent(data){
	...
	if(data == ''){
		...
		var sLi = "";
		sLi += '<img  id="xuwanting" src="/Public/uploads/'+data+'">';
		return sLi;
	}
}
function SetImgphoto(data){
	if(data == ''){		
		...
		sLi160 += '<img id="crop_preview" src="/Public/uploads/'+data+'">';
		sLi160 += '</div></div>160X160 像素</li>';
		sLi160 += '<li class="li80"><div class="w80"><div id="w80">';
		sLi160 += '<img id="crop_preview2" src="/Public/uploads/'+data+'">';
		sLi160 += '</div></div>80X80 像素</li>';
		sLi160 += '<li class="li30"><div class="w30"><div id="w30">';
		sLi160 += '<img id="crop_preview3" src="/Public/uploads/'+data+'">';
...
<div class="R-content">
    <link rel="stylesheet" type="text/css" href="/Public/piyungou/js/jquery.Jcrop.css" />
<link rel="stylesheet" href="/Public/piyungou/js/uploadify.css" type="text/css"> 
<script type="text/javascript" src="/Public/piyungou/js/jquery.Jcrop.js"></script>
<script type="text/javascript" src="/Public/piyungou/js/jquery.uploadify-3.1.min.js"></script> 
<link href="/Public/piyungou/js/style.css" rel="stylesheet" type="text/css" />
<link href="/Public/piyungou/js/demo.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/Public/piyungou/js/jquery.Validform.min.js"></script>
<div class="subMenu">
	<?php if($biaoti == '编辑个人资料'): ?><a class="current2 current" href="/user/userModify"> <?php else: ?><a class="current2" href="/user/userModify"><?php endif; echo (L("web_setting_persion")); ?></a>
	<?php if($biaoti == '修改头像'): ?><a class="current" href="/user/userphoto"> <?php else: ?><a href="/user/userphoto"><?php endif; echo (L("web_setting_icon_change")); ?></a>
	<?php if($biaoti == '收货地址'): ?><a class="current" href="/user/address"> <?php else: ?><a href="/user/address"><?php endif; echo (L("web_setting_address")); ?></a>
	<?php if($biaoti == '密码修改'): ?><a class="current" href="/user/password"> <?php else: ?><a href="/user/password"><?php endif; echo (L("web_setting_password_change")); ?></a>
</div>

	<div id="urlxx"></div>
	<div class="uploadCon" style="margin-top:20px;">
		<div class="upLeft">
            <div class="gray02"><?php echo (L("web_setting_upload")); ?></div>
			<div class="upload" style="float:left; width:300px;"><input type="file" name="file_upload"  id="file_upload" multiple="true" /></div>
			<div class="frameCut">
				<div class="zhix"></div>
				<div id="divImgTip" class="text"><?php echo (L("web_setting_select_pic")); ?></div>
				<div class="pic">					
				</div>
			</div>
			<span class="tishi gray02"><?php echo (L("web_setting_shears_pic")); ?></span>
			<div class="savePhoto">
				<form action="/user/userphotoinsert" method="post" id="crop_form">
					<input type="hidden" id="x" name="x" />
					<input type="hidden" id="y" name="y" />
					<input type="hidden" id="w" name="w" />
					<input type="hidden" id="h" name="h" />
					<input type="hidden" id="membimg" name="img" />
					<input id="crop_submit" type="submit"name="submit" class="bluebut" value=<?php echo (L("web_setting_save_icon")); ?> title=<?php echo (L("web_setting_save_icon")); ?>/>
				</form>
			</div>
		</div>
		<div class="upRight">
			<p class="gray02"><?php echo (L("web_setting_upload_icon")); ?></p>
			<div class="photo gray02">
				<ul>
                                        <?php if((empty($huiyuan['img'])) OR ($huiyuan['img'] == 'photo/member.jpg') ): ?><li class="li160"><div class="w160"><div id="w160"><img id="crop_preview" src="/Public/uploads/photo/member.jpg_160160.jpg" width="160" height="160"  /></div></div>160X160 <?php echo (L("web_setting_pixel")); ?></li>
					<li class="li80"><div class="w80"><div id="w80"><img id="crop_preview2" src="/Public/uploads/photo/member.jpg_8080.jpg" width="80" height="80"  /></div></div>80X80 <?php echo (L("web_setting_pixel")); ?></li>
					<li class="li30"><div class="w30"><div id="w30"><img id="crop_preview3" src="/Public/uploads/photo/member.jpg_3030.jpg" width="30" height="30"  /></div></div>30X30 <?php echo (L("web_setting_pixel")); ?></li>
					<?php else: ?>			
					<li class="li160"><div class="w160"><div id="w160"><img id="crop_preview" src="/Public/uploads/<?php echo ($huiyuan['img']); ?>_160160.<?php echo img($huiyuan['img']);?>" /></div></div>160X160 <?php echo (L("web_setting_pixel")); ?></li>
					<li class="li80"><div class="w80"><div id="w80"><img id="crop_preview2" src="/Public/uploads/<?php echo ($huiyuan['img']); ?>_8080.<?php echo img($huiyuan['img']);?>" /></div></div>80X80 <?php echo (L("web_setting_pixel")); ?></li>
					<li class="li30"><div class="w30"><div id="w30"><img id="crop_preview3" src="/Public/uploads/<?php echo ($huiyuan['img']); ?>_3030.<?php echo img($huiyuan['img']);?>" /></div></div>30X30 <?php echo (L("web_setting_pixel")); ?></li><?php endif; ?>
				</ul>
			</div>
		</div>
	</div>
