    ...
    <body>
            ...
            <table width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align='center'><a target="_blank" href="<?php echo $row['url']; ?>"><?php echo $row['name']; ?></a></th>
                            <td align='center'><?php echo ($row['status']=='Y') ? '显示' : '隐藏'; ?></td>
                            <td align='center'><?php if($row['type']=='index'){ echo '头部导航'; }else if($row['type']=='footer'){echo '脚部导航';}else{echo '发现导航';}?></td>
                            <td align='center'>
                                <a href="/menu/editnav/id/<?php echo $row['cid']; ?>">修改</a><span class="span_fenge lr5">|</span>
        ...
        <script>
            ...
            function confirmurl(id, str) {
                if (confirm(str)) {
                    location.href = '/menu/navdel/id/' + id;
                }
            }
        </script>
    </body>
