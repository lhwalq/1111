...
<div class="subMenu">
	...
	<div class="pwdCon">
	<form class="registerform" method="post" action="/user/userpassword">
	<table border="0" cellpadding="0" cellspacing="0" align="center">
		<tbody>
			<tr>
				<!--<td align="right"><label>初次QQ登陆后的默认密码是: </label></td>-->
				<td>
					<lable style='line-height:23px'>
					    <?php
 if(!$huiyuan['qq_pass']){ echo ""; }else{ echo ""; } ?>
					</label>
				</td>
			</tr>
			<tr>
				<td align="right"><label><?php echo (L("web_setting_old_password")); ?>：</label></td>
				<td><input name="password" sucmsg=" " ajaxurl="/user/oldpassword" datatype="*6-20" nullmsg=<?php echo (L("web_setting_password_no_empty")); ?> errormsg=<?php echo (L("web_user_hini_password")); ?>  type="password" class="pwd" maxlength="20"></td>
				<td id="lOldPass"><div class="Validform_checktip"><?php echo (L("web_setting_shuru_password")); ?></div></td>
			</tr>
			<tr>
				<td align="right"><label><?php echo (L("web_setting_new_password")); ?>：</label></td>
				<td><input name="userpassword" plugin="passwordStrength" datatype="*6-20" nullmsg=<?php echo (L("web_setting_password_no_empty")); ?> errormsg=<?php echo (L("web_user_hini_password")); ?>  type="password" class="pwd" maxlength="20"></td>
				<td id="lNewPass"><div class="Validform_checktip"><?php echo (L("web_user_hini_password")); ?></div></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><div id="passqiang" class="passwordStrength"><i style="float:left;"><?php echo (L("web_user_password_intensity")); ?>：</i><span><?php echo (L("web_user_weak")); ?></span><span><?php echo (L("web_user_centre")); ?></span><span class="last"><?php echo (L("web_user_stubborn")); ?></span></div></td>
			</tr>
			<tr>
				<td align="right"><label><?php echo (L("web_setting_shuru_new_password")); ?>：</label></td>
				<td><input name="userpassword2" recheck="userpassword" sucmsg=" " datatype="*6-20" nullmsg=<?php echo (L("web_setting_shuru_new_password")); ?> errormsg=<?php echo (L("web_setting_shuru_new_password_two")); ?> id="NewPassAgain" type="password" class="pwd" maxlength="20"></td>
				<td id="lNewPassAgain"><div class="Validform_checktip"><?php echo (L("web_setting_shuru_new_password")); ?>！</div></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
