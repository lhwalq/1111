...
<div class="R-content">
	...
	<div class="email_verification">
		...
		<form class="registerform" method="post" action="/user/sendsuccess">
		...
		<div  class="text_email" style="padding-top:0px"><div class="Validform_checktip">点击“发送验证邮件”一元云购系统将会给您发送一封验证邮件到您的邮箱！</div></div>
		</form>
	</div>
</div>
