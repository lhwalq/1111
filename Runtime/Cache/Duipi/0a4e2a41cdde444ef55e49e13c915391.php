...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" charset="utf-8" src="/yyg/Public/plugin/calendar/calendar.js"></script>
        <style>
                                ...
                                <table width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="100px" align="center">一元云购次数</th>
                                            <th width="100px" align="center">消费金额</th>
                                            <th width="100px" align="center">时间</th>  
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php  for($j=0;$j<count($pay_list);$j++){ ?>
                                        <tr>
                                            <td align="center">
                                                <?php  if($pay_list[$j]['username'])echo $pay_list[$j]['username'];else if($pay_list[$j]['mobile'])echo $pay_list[$j]['mobile'];else {echo $pay_list[$j]['email'];}?>
                                            </td>
