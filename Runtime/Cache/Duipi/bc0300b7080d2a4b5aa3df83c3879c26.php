    ...
    <head>
        ...
        <style type="text/css">
            *{margin:0;padding:0;}
            ...
            .box-title{ background:<?php if((isset($config['titlebg']))): echo ($config['titlebg']); else: ?>#EC610C<?php endif; ?>;height:30px;line-height:33px;_line-height:30px;font-size: 14px;color:<?php if((isset($config['title']))): echo ($config['title']); else: ?>#fff<?php endif; ?>; padding:0 10px;}
        ...
        <script>
            ...
            var i = <?php echo ($time); ?>;
            if (i != 0){window.close_id = setInterval(function() {
            if (i > 0) {
            document.getElementById('time').innerHTML = i; i = i - 1;
            } else {
    ...
    <body>
        <div class="box">
            <div class="box-b">
                ...
                <div class="box-button"><a class="a-2" href="javascript:;" onclick="locahost()"><font id="time" style="color:red;"><?php echo ($time); ?></font>秒后返回上一页面
				</a><a class="a-1" href="<?php echo ($str_url_two['url']); ?>"><?php echo ($str_url_two['text']); ?></a></div> 
