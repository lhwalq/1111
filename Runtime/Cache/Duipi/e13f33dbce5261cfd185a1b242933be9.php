...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <script>
            function qishu(id) {
                if (confirm("确定删除该晒单")) {
                    window.location.href = "/goods/qishu_del/qishu/" + id;
                }
            }
        </script>
                ...
                <tbody style="text-align:center">				
                    ...
                    <tr>
                        ...
                        <td>第(<?php echo $v['qishu']; ?>)期 <span style="<?php echo $v['title_style']; ?>">
                                <a target="_blank" href="/goods/dataserverForPc/goodsId/<?php echo $v['id'];?>"><?php echo R('base/strcut',array($v['title'],30));?></a></span></td>
                        <td><a href="/goods/goods_list/order/<?php echo $v['cateid']; ?>"><?php echo $cate_name; ?></a></td>
                        ...
                        <td><?php
 if($v['q_end_time']){ $v['q_user'] = unserialize($v['q_user']); echo '<font color="#0c0">已揭晓</font>'; echo "<br>"; echo "<a href='".C("URL_DOMAIN").'user/uname/d/'.$v['q_uid']."'".R("Base/huode_user_name",array($v['q_user']))."</a>"; }else{ echo "未揭晓"; } ?>
                        </td>
                        <td class="action">
                            [<a href="/goods/goods_edit/id/<?php echo $v['id'];?>">修改</a>] 
                            [<a href="/goods/goods_del/id/<?php echo ($v['id']); ?>/qishu/<?php echo ($v['qishu']); ?>" onclick="return confirm('是否真的删除该商品！');">删除</a>]
                            [<a href="/goods/goods_go_one/id/<?php echo $v['id'];?>">购买详细</a>]
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
