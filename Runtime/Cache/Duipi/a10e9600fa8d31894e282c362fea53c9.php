...
<div class="layout980">
    <div class="groups-left">
        <div class="Topic-head">
            <div class="Topic-Himg"><a href="" class="fl-img"><img src="/Public/uploads/<?php echo ($quanzi['img']); ?>" id="imgGroupIco" border="0"></a></div>
            <div class="Topic-HC">
                <div class="Topic-Htit gray03">
                    <h2><a id="thisGroupName" href="" class="orange"><?php echo ($quanzi['title']); ?></a></h2> 
                    <?php if($quanzi['jiaru'] == 'Y'): if(!$addgroup): ?><a id="btnJoinGroup" href="javascript:;" class="button04">申请加入</a>
                            <?php else: ?>
                            <span class="JoinOut" id="spanJoinOut"><s></s>已加入<i>|</i><a id="btnJoinOutGroup" href="javascript:;" class="blue">退出</a></span><?php endif; endif; ?>
                </div>
            ...
            <div class="Managers">
                <a class="Managers-icon" type="showCard" href="/user/uname/d/<?php echo R('Base/idjia',array($quanzi['guanli']));?>"></a>
                <div class="Managers-Himg"><a href="/user/uname/d/<?php echo R('Base/idjia',array($quanzi['guanli']));?>" type="showCard" class="fl-img">
                        <?php if(!R('Base/userid',array($quanzi['guanli'],'img'))): ?><img src="/Public/images/prmimg.jpg" width="50" height="50" />
                            <?php else: ?>
                            <img id="imgUserPhoto" src="/Public/uploads/<?php echo R('Base/userid',array($quanzi['guanli'],'img'));?>" width="50" height="50" border="0"/><?php endif; ?>				
                    </a>
                    <p class="Managers-name"><a type="showCard" href="/user/uname/d/<?php echo R('Base/idjia',array($quanzi['guanli']));?>" class="blue"><?php echo R('Base/userid',array($quanzi['guanli'],'username'));?></a></p>
                </div>
            </div>
        </div>
        <div class="msg">
        ...
        <div class="Publish">
            ...
            <div id="divEditor" class="Pub-topic hidden">
                <form action="/group/showinsert" method="post">
                    <p class="Pub-tit"><b></b><input id="txtTopicTitleEx" maxlength="100" type="text" name="title" value=""></p>				
                    <!--编辑器开始-->				
                    <link href="/Public/plugin/umeditor3/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
                    <script type="text/javascript" src="/Public/plugin/umeditor3/third-party/jquery.min.js"></script>
                    <script type="text/javascript" charset="utf-8" 
                    src="/Public/plugin/umeditor3/umeditor.config.js"></script>
                    <script type="text/javascript" charset="utf-8" 
                    src="/Public/plugin/umeditor3/umeditor.min.js"></script>
                    <script type="text/javascript" src="/Public/plugin/umeditor3/lang/zh-cn/zh-cn.js"></script>
                    ...
                    <body>
                        ...
                        <div class="Pub-btn-r">
                            <div  style="line-height:25px;display: inline-block;padding:0px;">
                                <span style=" float:right"><img onclick="this.src = this.src + '/0'" src="/Tools/checkcode/style/image/type/60_25_0_0_4"/></span>
        ...
        <?php if($zongji == 0): ?><div class="tips-con"><i></i>暂无话题，快抢沙发吧！</div>
            <?php else: ?>
            <?php if(is_array($qz)): foreach($qz as $key=>$dongtai): ?><div class="Topiclist">
                    <div class="Topiclist-img">
                        <a type="showCard" href="/user/uname/d/<?php echo R('Base/idjia',array($dongtai['hueiyuan']));?>" class="head-img">
                            <?php if(!R('Base/userid',array($dongtai['hueiyuan'],'img'))): ?><img src="/Public/images/prmimg.jpg" width="50" height="50" />
                                <?php else: ?>
                                <img id="imgUserPhoto" src="/Public/uploads/<?php echo R('Base/userid',array($dongtai['hueiyuan'],'img'));?>" width="50" height="50" border="0"/><?php endif; ?>	
                        </a>
                        <a type="showCard" rel="nofollow" href="/user/uname/d/<?php echo R('Base/idjia',array($dongtai['hueiyuan']));?>" class="blue"><?php echo R('Base/userid',array($dongtai['hueiyuan'],'username'));?></a>
                    </div>
                    <div class="Topiclist-RC "><b class="arrow"></b>
                        <div class="R-tit gray">
                            <?php if($dongtai['zhiding'] == 'Y'): ?><a href="/group/nei/id/<?php echo ($dongtai['id']); ?>" class="red"><?php echo ($dongtai['title']); ?></a>
                                <i class="zhiding"></i>&nbsp;
                                <?php else: ?>
                                <a href="/group/nei/id/<?php echo ($dongtai['id']); ?>"><?php echo ($dongtai['title']); ?></a> 
                                <!--  <i class="jing"></i>&nbsp; --><?php endif; ?>
                            <span class="time"><?php echo (date("Y年m月d日 H:i",$dongtai['time'])); ?></span>
                        </div>
                        <div class="gray02"><?php echo R("Base/strcut",array($dongtai['neirong'],160));?></div>
                        <div class="topic-reply">
                            <div>
                                <a href="/group/nei/id/<?php echo ($dongtai['id']); ?>" class="gray02">回复<span class="gray03">(<?php echo ($dongtai['hueifu']); ?>)</span></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="/group/nei/id/<?php echo ($dongtai['id']); ?>" class="gray02">人气<span class="gray03">(<?php echo ($dongtai['dianji']); ?>)</span></a>
                            </div>
                            <span class="gray03">最后回复：<a href="/user/uname/d/<?php echo R('Base/idjia',array($dongtai['zuihou']));?>" class="blue"><?php echo R('Base/userid',array($dongtai['zuihou'],'username'));?></a>&nbsp;&nbsp;<?php echo (date("Y年m月d日",$dongtai['time'])); ?>&nbsp;&nbsp;</span>			
                        </div>
                    </div><p class="Topicline"></p>
                </div><?php endforeach; endif; ?>
            <?php if($zongji > $num): ?><div class="pagesx"><?php echo $fenye->show("two");?></div><?php endif; endif; ?>	
    </div>
    <link href="/Public/piyungou/css/groups.css" rel="stylesheet" type="text/css" />
<div class="groups-right">
    <div class="groups-head">
        <?php if(R('Base/uidcookie',array('uid'))): ?><div class="grhead-img"><a href="/user/uname/d/<?php echo R('Base/idjia',array(R('Base/uidcookie',array('uid'))));?>" class="fl-img">		
                    <?php if(!R('Base/userid',array(R('Base/uidcookie',array('uid')),'img'))): ?><img src="/Public/images/prmimg.jpg" width="50" height="50" />
                        <?php else: ?>
                        <img id="imgUserPhoto" src="/Public/uploads/<?php echo R('Base/userid',array(R('Base/uidcookie',array('uid')),'img'));?>" width="50" height="50" border="0"/><?php endif; ?>	
            </div>
            <div class="grhead-info">
                <p class="grhead-name"><a href="/user/uname/d/<?php echo R('Base/idjia',array(R('Base/uidcookie',array('uid'))));?>" class="gray" ><?php echo R('Base/userid',array(R('Base/uidcookie',array('uid')),'username'));?></a></p>
                <p class="grhead-topic gray02">话题<?php echo R('Base/huati',array('tiezi'));?><span class="gray03"> | </span>回复<?php echo R('Base/huati',array('hueifu'));?></p>
                <div id="divJoinGroup">
                    <p id="pJoinGroup" class="grhead-join gray02"> 加入圈子<span id="spJoinGroupNum" class="orange"><?php echo R('Base/qznum');?></span>个<b></b></p>
                </div>
            </div>	
            <?php else: ?>
            <div class="groups-login">
                <p class="grhead-loginc1 gray02">登录查看您的圈子吧！</p>
                <p class="grhead-login-reg gray02">没账号？ <span><a href="/user/register" target="_blank" class="gray01">简单注册 快捷方便！</a></span></p>
                <a id="btnLogin" href="/user/login" class="button07">立即登录</a>
            </div><?php endif; ?>
    </div>
    <div class="blank10"></div>
    <div id="divHotTopic" class="groups-shadow clearfix">
        <div class="R-grtit"><h3>热门话题</h3></div>
        <?php $dongtai = D("quan_tiezi")->group("hueiyuan")->order("id desc")->limit("5")->select(); ?>
        <?php if(is_array($dongtai)): foreach($dongtai as $key=>$tz): ?><div class="R-list Topic-list">
                <div class="groups-Rimg">
                    <a type="showCard" href="/user/uname/d/<?php echo R('Base/idjia',array($tz['hueiyuan']));?>" class="fl-img">				
                        <?php if(!R('Base/userid',array($tz['hueiyuan'],'img'))): ?><img src="/Public/images/prmimg.jpg" width="30" height="30" />
                            <?php else: ?>
                            <img id="imgUserPhoto" src="/Public/uploads/<?php echo R('Base/userid',array($tz['hueiyuan'],'img'));?>" width="30" height="30" border="0"/><?php endif; ?>	
                    </a></div>
                <div class="groups-Rinfo">
                    <p class="groups-ht"><a href="/group/nei/id/<?php echo ($tz['id']); ?>" class="gray"> <?php echo ($tz['title']); ?></a></p>
                    <p class="groups-c gray02"><?php echo R('Base/strcut',array(R('Base/quanzid',array($tz['qzid'])),10));?><span class="gray03"> | </span><?php echo R('Base/huifu',array($tz['id']));?>条回复</p>
                </div>
            </div><?php endforeach; endif; ?>
    </div>
    <div class="blank10"></div>
    <div class="groups-shadow clearfix">
        ...
        <div class="Member-list clearfix">
            <ul id="ulMember">
                <?php if(is_array($hueifu)): foreach($hueifu as $key=>$hf): ?><li><a type="showCard" href="/user/uname/d/{wc:fun:idjia($hf['hueiyuan'])}" class="blue">
                            <?php if(!R('Base/userid',array($hf['hueiyuan'],'img'))): ?><img src="/Public/images/prmimg.jpg" width="50" height="50" />
                                <?php else: ?>
                                <img id="imgUserPhoto" src="/Public/uploads/<?php echo R('Base/userid',array($hf['hueiyuan'],'img'));?>" width="50" height="50" border="0"/><?php endif; ?>	
                            <i><?php echo R('Base/userid',array($hf['hueiyuan'],'username'));?></i></a>
                    </li><?php endforeach; endif; ?>
...
<script>
    $(function () {
        ...
        $("#txtTopicTitle,#btnPostTopic").click(function () {
            var uid = "<?php echo R('Base/uidcookie',array('uid'));?>";
            var text = $("#btnJoinOutGroup").text();
            if (!uid) {
                alert("你未登录！");
            } else if (!text) {
