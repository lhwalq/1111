            ...
            <table width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><?php echo R('base/strcut',array($v['logo'],30));?></td>
                        <td align="center"><?php echo $v['url'];?></td>
                        <td align="center">
                            <a href="/link/edit/id/<?php echo $v['id'];?>">修改</a>
                            <span class='span_fenge lr5'>|</span>
                            <a href="/link/delete/id/<?php echo $v['id'];?>" onClick="return confirm('是否真的删除！');">删除</a>
                        </td>	
                    </tr>
                    <?php } ?>
                </tbody>
