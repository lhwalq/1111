...
<div class="R-content">
	<div class="member-t"><h2><?php echo (L("web_setting_yungou_history")); ?></h2></div>
	<div id="GoodsList" class="goods_show">
		<ul class="gtitle">
			...
			<li class="yg_status"><?php echo (L("web_setting_cloud_state")); ?></li>
			<li class="joinInfo"><?php echo (L("web_setting_go_num")); ?></li>
		...
		<?php if($jiexiao['q_uid'] and $showtime[q_showtime] == N ): ?><ul class="goods_list">	
			...
			<li class="gname"style="margin:10px 0 0 0;">
				...
				<a target="_blank" href="/goods/dataserverForPc/goodsId/<?php echo ($rt['shopid']); ?>_<?php echo ($rt['shopqishu']); ?>.html" class="blue"><?php echo (L("web_user_di")); ?>(<?php echo ($rt['shopqishu']); ?>)<?php echo (L("web_user_qi")); ?> <?php echo ($rt['shopname']); ?></a>
				<p class="gray02"><?php echo (L("web_lottery_gainer")); ?>：<a href="/user/uname/d/{fun:idjia($jiexiao['q_uid'])}.html" target="_blank" class="blue">
				...
				<p class="gray02"><?php echo (L("web_lottery_time")); ?>：<?php echo R('base/microt',array($jianginfo['q_end_time']));?></p>
			</li>
			<li class="yg_status" style="margin:23px 0 0 0;"><span class="orange"><?php echo (L("web_setting_yes")); ?></span></li>
			<li class="joinInfo" style="margin:23px 0 0 0;"><p><em><?php echo ($rt['gonumber']); ?></em><?php echo (L("web_lottery_person")); ?></p></li>
			<li class="do" style="margin:23px 0 0 0;"><a href="/user/userbuydetail/id/<?php echo ($rt['id']); ?>" class="blue" title=<?php echo (L("web_setting_detail")); ?>><?php echo (L("web_setting_detail")); ?></a></li>
		</ul>
		<?php else: ?>
		<ul class="goods_list">	
			...
			<li class="gname" style="margin:15px 0 0 0;">
				<a target="_blank" href="/goods/items/goodsId/<?php echo ($rt['shopid']); ?>.html" class="blue"><?php echo (L("web_user_di")); ?>(<?php echo ($rt['shopqishu']); ?>)<?php echo (L("web_user_qi")); ?> <?php echo ($rt['shopname']); ?></a>
				<p class="gray02"><?php echo (L("web_setting_time")); ?>：<?php echo R('base/microt',array($rt['time']));?></p>
			</li>
			<li class="yg_status" style="margin:23px 0 0 0;"><span class="orange"><?php echo (L("web_setting_ing")); ?>...</span></li>
			<li class="joinInfo" style="margin:23px 0 0 0;"><p><em><?php echo ($rt['gonumber']); ?></em><?php echo (L("web_lottery_person")); ?></p></li>
			<li class="do" style="margin:23px 0 0 0;"><a href="/user/userbuydetail/id/<?php echo ($rt['id']); ?>" class="blue" title=<?php echo (L("web_setting_look_cloud")); ?>><?php echo (L("web_setting_look_cloud")); ?></a></li>
