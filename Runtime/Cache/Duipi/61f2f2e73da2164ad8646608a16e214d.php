            ...
            <form name="myform" action="" method="post">
                <table width="100%" cellspacing="0" >	
                    <tr>
                        ...
                        <td>
                            <?php if((C('watermark_off'))): ?><input type="radio" name="watermark_off" value="1" checked="checked" /><span> 启用</span>
                                <input type="radio" name="watermark_off" value="0" /><span> 关闭</span>
                                <?php else: ?>
                                <input type="radio" name="watermark_off" value="1" /><span> 启用</span>
                                <input type="radio" name="watermark_off" value="0" checked="checked" /><span> 关闭</span><?php endif; ?>
                        </td>
                    </tr>	
                    <tr>
                        <td width="120">水印类型:</td>
                        <td>
                            <?php if((C('watermark_type') == 'text')): ?><input type="radio" name="watermark_type" onClick="show_div('text')" value="text" checked="checked" /><span> 文字水印</span>
                                ...
                                <input type="radio" name="watermark_type" onClick="show_div('image')" value="image" checked="checked" /><span> 图片水印</span><?php endif; ?>
                        </td>
                    </tr>
                    <tr class="watermark_text">
                        <td width="120">水印文字:</td>
                        <td>
                            <input type="text" name="text" value="<?php echo C('watermark_text.text');?>"  class="input-text wid200"><br/>
                        </td>
                    </tr>
                    <tr class="watermark_text">
                        <td width="120">文字颜色:</td>
                        <td>
                            <input type="text" name="color" value="<?php echo C('watermark_text.color');?>"  class="input-text">
                    ...
                    <tr class="watermark_text">
                        ...
                        <td>
                            <input type="text" name="size" value="<?php echo C('watermark_text.size');?>"  class="input-text"><br/>
                        </td>
                    </tr>
                    </div>
                    <tr class="watermark_image">
                        ...
                        <td>
                            <input type="text" name="width" value="<?php echo C('watermark_condition.width');?>"  class="input-text">图片宽度 单位像素(px)<br/>
                                <input type="text" name="height" value="<?php echo C('watermark_condition.height');?>"  class="input-text">图片高度 单位像素(px)
                                    </td>
                                    </tr>	 
                                    <tr class="watermark_image">
                                        <td width="120">水印图片:</td>
                                        <td>    
                                            <input type="text" id="imagetext" value="<?php echo C('watermark_image');?>" name="image" class="input-text wid300">
                                                <input type="button" class="button"
                                                       onClick="GetUploadify('<?php echo C("URL_DOMAIN");?>', 'uploadify', '缩略图上传', 'image', 'banner', 1, 500000, 'imagetext')" 
                                                       value="上传图片"/>		      
                                        </td>           
                                    </tr>	
                                    <tr class="watermark_image">
                                        <td width="120">水印透明度:</td>
                                        <td><input type="text" name="apache" value="<?php echo C('watermark_apache');?>"  class="input-text"><span> 请设置为0-100之间的数字，0代表完全透明，100代表不透明</span></td>
                                    </tr>	
                                    <tr class="watermark_image">
                                        <td width="120">JPEG 水印质量:</td>
                                        <td><input type="text" name="good" value="<?php echo C('watermark_good');?>"  class="input-text"><span> 水印质量请设置为0-100之间的数字,决定 jpg 格式图片的质量</span></td>
                                    </tr>		
                                    <tr class="watermark_image">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        $(function () {
                                            $("#sel_<?php echo C('watermark_position');?>").attr("checked", "checked");

                                        });
                                                <?php if((C('watermark_type') == 'text')): ?>show_div('text');
                                                <?php else: ?>
                                                show_div('image');<?php endif; ?>
                                    </script>
                                    </body>
                                    </html>