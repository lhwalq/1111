            ...
            <form action="" method="post" id="myform">
                <table width="100%" class="lr10">
                    <tr>
                        ...
                        <td>
                            <input name="type" value="1" type="radio" <?php $qq=C('qq_config'); if($qq['off'])echo "checked";?> /> 开启
                                   <input name="type" value="0" type="radio" <?php if(!$qq['off'])echo "checked";?> /> 关闭 	 
                                   <span class="lr10"> </span>
                                    ...
                                    <tr>
                                        <td>QQ App id</td>
                                        <td><input type="text" class="input-text wid150" name="id" value="<?php echo $qq['id']; ?>"/></td>
                                    </tr>  
                                    <tr>
                                        <td>QQ App key</td>
                                        <td><input type="text" class="input-text wid250" name="key"  value="<?php echo $qq['key']; ?>"/>
