                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tbody>				
                        ...
                        <tr>
                            ...
                            <td><?php echo $v['id'];?></td>
                            <td><a href="/article/article_list/cateid/<?php echo $v['cateid']; ?>"><?php echo $categorys[$v['cateid']]['name'];?></a></td>
                            <td><?php echo R('base/strcut',array($v['title'],0,25));?></td>
                            <td><?php echo $v['author']; ?></td>
                            <td><?php echo $v['hit']; ?></td>
                            <td><?php echo date("Y-m-d H:i:s",$v['posttime']);?></td>
                            <td class="action">
                                <a href="/article/article_edit/id/<?php echo $v['id'];?>">修改</a>
                                <span class='span_fenge lr5'>|</span>    
                                <a href="/article/article_del/id/<?php echo $v['id'];?>" onclick="return confirm('确认删除这篇文章吗？');">删除</a>
        ...
        <div class="btn_paixu">
            <div style="width:80px; text-align:center;">
                <input type="button" class="button" value=" 排序 "
                       onclick="myform.action = '/article/article_listorder/type/dosubmit';
                               myform.submit();"/>
            </div>
        </div>
