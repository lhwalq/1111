...
<!--content left end-->
<link rel="stylesheet" type="text/css" href="/Public/css/layout-setUp.css"/>
<link rel="stylesheet" type="text/css" href="/Public/css/accountess.css"/>
<link rel="stylesheet" type="text/css" href="/Public/css/commess.css"/>
<style>
...
$(function(){
	...
	$('.queren').click(function(){
		...
		$.post("/user/panduan",{val:yanzheng,code:code,uid:uid,newcode:newemails},function(data){
			if(data!=''){
	...
	$(".c_get_codemobile").click (function() {
		...
		if(validCode1){
			...
			if(cuowu==""){
				$.post("/user/panduan",{newmobile:newphone,val:info,uid:uid},function(data){
					//alert(data);
					if(data!=0){
	...
	$('.tijiao').click(function(){
		...
		if(cuowu==""){
			...
			if(newemail!=""){
				yan=$(this).attr('index');	
				$.post("/user/panduan",{newemail:newemail,val:yan,uid:uid},function(data){
					//alert(data);
					if(data==0){
	...
	$('.c_resentemail').click(function(){
		$.post("/user/panduan",{val:val,info:emailinfo,uid:uid},function(data){
...
<div class="subMenu">
	...
	<div class="prompt orange"><?php echo (L("web_setting_perfect_first")); echo C('web_name_two'); echo (L("web_setting_perfect_last")); ?><s></s></div>
	<div class="info">
		<table border="0" cellpadding="0" cellspacing="8">
			<!--<tr>    <?php if(($huiyuan['mobile'] != null) AND ($huiyuan['mobilecode'] == '1') ): ?>-->
				<!--<td align="right"><em><font>*</font><label>手机：</label></em></td>-->
				<!--<td style='width:300px'>-->
					<!--<b calss="mobilecode"><?php echo ($huiyuan['mobile']); ?></b> -->
					 <!--已验证-->
				<!--</td>-->
				<!---->
				<!--<?php else: ?>-->
				<!--<td align="right"><em><font>*</font><label>手机：</label></em></td>-->
				<!--<td>-->
					<!--<a style="margin-left:0;" href="/user/mobilechecking" title="绑定手机">绑定手机</a>-->
				<!--</td>-->
				<!--<?php endif; ?>-->
			<!--</tr>-->
			<!--<tr>-->
                                <!--<?php if(($huiyuan['email'] != null) AND ($huiyuan['emailcode'] == '1') ): ?>-->
				<!--<td align="right"><em><font>*</font><label>邮箱：</label></em></td>-->
				<!--<td style='width:300px'>-->
					<!--<b><?php echo ($huiyuan['email']); ?></b> -->
					 <!--已验证-->
					<!--<div class="y_account_div_a" style='display:inline' index="email" emailinfo="<?php echo ($huiyuan['email']); ?>" uid="<?php echo ($huiyuan['uid']); ?>">-->
						...
						<!--<div class="c_update_way">-->
							<!--<div class="c_by_way" style="display:block;">-->
								...
								<!--<div class="c_mobile_valid secondemail" style="display:none">-->
									...
									<!--<p>注意：原邮箱已不可用，若不去新邮箱激活，则需重新<a href="/member/user/login">登陆</a></p>-->
									<!--</div>-->
				...
				<!--<td align="right"><em><font>*</font><label>邮箱：</label></em></td>-->
				<!--<td>-->
					<!--<a style="margin-left:0;" href="/user/mailchecking" title="绑定邮箱">绑定邮箱</a>-->
				<!--</td>-->
				<!--<?php endif; ?>-->
			<!--</tr>-->
			<!--<tr>-->
                                 <!--<?php if(($huiyuan_qq['b_id'] != null) OR ($huiyuan_qq['b_type'] == 'qq') ): ?>-->
				...
				<!--<td align="right"><em><font>*</font><label>QQ：</label></em></td>-->
				<!--<td>-->
					<!--<a style="margin-left:0;" href="/user/qqclock" title="请绑定qq">请绑定qq</a>-->
				<!--</td>-->
				<!--<?php endif; ?>-->
			<!--</tr>-->
	<form class="registerform" method="post" action="/user/nicheng">
			<tr>
				<td align="right"><em><font>*</font><label><?php echo (L("web_setting_nickname")); ?>：</label></em></td>
				<td>
					<input id="nicxx" datatype="nic" nullmsg=<?php echo (L("web_setting_nickname_no")); ?> name="txtnicheng" value="<?php echo ($huiyuan['username']); ?>" type="text"  class="txt gray" maxlength="20" />
				</td>					
				<td><div class="Validform_checktip"><?php echo (L("web_setting_nickname_hint")); ?></div></td>
			</tr>
			<tr>
				<td align="right"><em><font>&nbsp;</font><label><?php echo (L("web_setting_sign")); ?>：</label></em></td>
                                 <?php if(($huiyuan['qianming'] == null)): ?><td><textarea name="qianming" class="info_txtarea gray03" ><?php echo (L("web_setting_me")); ?></textarea></td>
				<?php else: ?>
				<td><textarea name="qianming" class="info_txtarea gray03" ><?php echo ($huiyuan['qianming']); ?></textarea></td><?php endif; ?>
			</tr>
			<tr>
				<td><em>&nbsp;</em></td>
