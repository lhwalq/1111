...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="header-title lr10">
            ...
            <b><a href="/template/temp">邮件发送模板配置</a></b>
        </div>
        <div class="bk10"></div>
        <div class="table_form lr10">
            <form action="" method="post" id="myform">
                <table width="100%" class="lr10">
                    ...
                    <tr>
                        <td>邮件服务器</td>
                        <td><input type="text" class="input-text" name="server" size="30" value="<?php echo C('stmp_host');?>"/></td>
                    </tr>  
                    <tr>
                        <td>发件人地址</td>
                        <td><input type="text" class="input-text" name="email" size="30" value="<?php echo C('from');?>"/></td>
                    </tr> 
                    <tr>
                        <td>发件人姓名</td>
                        <td><input type="text" class="input-text wid80" name="name" size="30" value="<?php echo C('fromName');?>"/></td>
                    </tr>
                    <tr>
                        <td>发送编码</td>
                        <td><input type="text" class="input-text wid80" name="big"  value="<?php echo C('big');?>"/></td>
                    </tr> 
                    <tr>
                        <td>验证用户名</td>
                        <td><input type="text" class="input-text" name="user" size="30" value="<?php echo C('user');?>"/></td>
                    </tr> 
                    <tr>
                        <td>验证密码</td>
                        <td><input type="password" class="input-text" name="pass" size="30" value="<?php echo C('pass');?>"/></td>
                    </tr>  
                    <tr>
                        <td>测试邮件</td>
                        <td>
...
//                console.log(email);
                $.post("/config/email",{"type":"cesi","emails":email}, function (data) {
                    alert(data);
                });
            }
        </script>
