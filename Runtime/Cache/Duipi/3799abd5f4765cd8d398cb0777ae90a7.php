    ...
    <body>
        ...
        <div class="table-list lr10">
            <table width="100%" cellspacing="0">
                ...
                <tbody id="trlist">
                    <?php foreach($yuming_yys as $key=>$do){ ?>
                    <tr>
        ...
        <script>
            ...
            function install(T, y) {
                ...
                if (ret) {
                    $.post("/config/yuming/", {'yuming': values[0], 'module': values[1], 'action': values[2], 'func': values[3], 'dosubmit': y}, function (data) {
                        if (data == 'ok') {
            ...
            function removes(T) {
                var tr = $(T).parent().parent();
                var yuming = $(tr.find("td")[0]).text();
                $.post("/config/yuming/", {'yuming': yuming, 'dosubmit': 'del'}, function (data) {
                    if (data == 'ok') {
