                                            ...
                                            <input type="radio" name="mobilecode" value="1"  class="input-text">已验证
                                                <input type="radio" name="mobilecode" value="-1" checked class="input-text">未验证
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>				
                                                            <img src="/Public/uploads/photo/member.jpg" style="height:80px;width:80px;border:1px solid #eee;padding:1px">			
                                                                <input type="text" id="imagetext" name="thumb" value="photo/member.jpg" class="input-text wid300">
                                                                    <input type="button" class="button" onClick="GetUploadify('<?php echo C("URL_DOMAIN");?>', 'uploadify', '头像上传', 'image', 'touimg', 1, 500000, 'imagetext')" value="上传头像" />
                                                                    </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <select name="membergroup">
                                                                                <?php foreach($huiyuan_allgroup as $v){?>
