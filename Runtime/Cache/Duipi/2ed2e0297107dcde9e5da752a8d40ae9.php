...
<link rel="stylesheet" type="text/css" href="/Public/style/css/pager.css"></link>
  ...
  <div class="w_con"> 
   <h4 class="w_guide"><a href="/index/index"><?php echo (L("web_glist_first")); ?></a><a class="w_accord" href="/goodszg/glistzg"><?php echo (L("web_glist_all_goods")); ?></a></h4>
    ...
    <div class="w_choose"> 
     ...
     <?php if(is_array($two_cate_listda)): foreach($two_cate_listda as $key=>$two_cate): ?><dd>
      <?php  $urls=str_replace("_0_0", "", I("type")); ?>
       <a href="/goodszg/glistzg/type/<?php echo ($two_cate['cateid']); ?>_0_0.html" data-id="2" 
	...
	$(".list_classMore").click(showh);
	 ...
	 <dl class="w_goods_brand"> 
		...
		<dd  class="w_specific_class1">
         ...
         <ul>
<li>
<a class="w_effect" href="/goodszg/glistzg/type/type/<?php echo ($cid); ?>_0_0.html"><?php echo (L("web_glist_all")); ?></a>
</li>
<?php if(is_array($two_cate_list)): foreach($two_cate_list as $key=>$two_cate): if($cid == $two_cate['cateid'] ): ?><li><a href="/goodszg/glistzg/type/<?php echo ($two_cate['cateid']); ?>_0_0.html" class="w_selected" title="<?php echo ($two_cate['name']); ?>"><?php echo ($two_cate['name']); ?></a></li>
					<?php else: ?>
					<li><a href="/goodszg/glistzg/type/<?php echo ($two_cate['cateid']); ?>_0_0.html" title="<?php echo ($two_cate['name']); ?>"><?php echo ($two_cate['name']); ?></a></li><?php endif; endforeach; endif; ?>
       ...
       <dl class="w_goods_brand"> 
		...
		<dd id="ddBrandList_brand" class="w_specific_class1" ><?php endif; ?>
         <ul>
<li>
<a class="w_effect" href="/goodszg/glistzg/type/<?php echo ($cid); ?>_0_<?php echo ($order); ?>.html">全部</a>
</li>
  <?php if(is_array($pinpai)): foreach($pinpai as $key=>$pinpais): if($pinpais['id'] == $bid): ?><li>
<a  href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($pinpais['id']); ?>_<?php echo ($order); ?>.html" class="w_selected"><?php echo ($pinpais['name']); ?></a>
</li>
<?php else: ?>
<li>
<a  href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($pinpais['id']); ?>_<?php echo ($order); ?>.html"><?php echo ($pinpais['name']); ?></a>
   ...
   <div class="w_product_con"> 
    <dl class="w_new"> 
     <dd>
      ...
      <dd>
      <a href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_1.html"  <?php if($order == '1'): ?>class="w_announced"<?php endif; ?> data-id="publicTime"><?php echo (L("web_lottery_unveiled")); ?></a>
     </dd> 
     <dd>
      <a href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_3.html"  <?php if($order == '3'): ?>class="w_announced"<?php endif; ?>  data-id="takedout"><?php echo (L("web_lottery_residue")); ?></a>
     </dd> 
     <dd>
      <a href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_2.html"  <?php if($order == '2'): ?>class="w_announced"<?php endif; ?>  data-id="periods"><?php echo (L("web_glist_hot_sale")); ?></a>
     </dd> 
     <dd>
      <a href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_4.html"  <?php if($order == '4'): ?>class="w_announced"<?php endif; ?> data-id="addTime"><?php echo (L("web_glist_new_goods")); ?></a>
     </dd> 
     <dd>
      <?php if($order == '5'): ?><a class="w_last" href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_6.html" data-id="totalPrice_up"><?php echo (L("web_glist_price")); ?><span><img src="/Public/style/images/jia_03.png" /></span><span class="w_jian_tou"><img src="/Public/style/images/jia_06.png" /></span></a>


 <?php else: ?>
     <?php if($order == '6'): ?><a class="w_last" href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_5.html" data-id="totalPrice_up"><?php echo (L("web_glist_price")); ?><span><img src="/Public/style/images/jia_03.png" /></span><span class="w_jian_tou"><img src="/Public/style/images/jia_06.png" /></span></a>


      <?php else: ?>

            <a class="w_last" href="/goodszg/glistzg/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_5.html" data-id="totalPrice_up"><?php echo (L("web_glist_price")); ?><span><img src="/Public/style/images/jia_03.png" /></span><span class="w_jian_tou"><img src="/Public/style/images/jia_06.png" /></span></a><?php endif; endif; ?>
     </dd> 
    </dl> 
   </div> 
   <!--商品列表--> 
   ...
   <?php if(is_array($yyslist)): foreach($yyslist as $key=>$shop): ?><li class="w_goods_details ">
      ...
      <dl class="w_rob">
       <dd>
        <a class="w_slip" target="_blank" href="/goodszg/itemszg/goodsId/<?php echo ($shop['id']); ?>.html" data-gid="<?php echo ($shop['id']); ?>" data-pid="<?php echo ($shop['zongrenshu']); ?>"><?php echo (L("web_glist_immediately")); ?></a>
       </dd>
