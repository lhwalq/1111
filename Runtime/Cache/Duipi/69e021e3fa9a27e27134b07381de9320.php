...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="bk10"></div>
        <form action="/menu/savenav" id="form" method="post">
            <table width="100%" class="table_form">
                <tbody>
                    <tr>
                        <th>导航名称：</th>
                        <td>
                            <input type="hidden" value="<?php echo $info['cid']; ?>" name="id" id="catname" class="input-text">
                                <input type="text" value="<?php echo $info['name']; ?>" name="name" id="catname" class="input-text">
                                    </td>
                                    </tr>  
                                    <tr>
                                        <th width="200">类别：</th>
                                        <td>
                                            <select name="type" id="modelid" onChange="">
                                                ...
                                                <option value="faxian"  <?php if($info['type']=='faxian'){ ?> selected=""<?php } ?>> ≡ 发现导航 ≡</option>
                                            </select>  
                                    </tr>	  
                                    <tr>
                                        <th>导航URL：</th>
                                        <td><input type="text" name="url" value="<?php echo $info['url']; ?>" style="width:350px;" id="catname" class="input-text">
                                                <span><font color="#0c0" size="">※ </font>前面默认会加上: <?php echo $_SERVER['HTTP_HOST']; ?></span>
                                        </td>        
                                    </tr>      
                                    <tr>
