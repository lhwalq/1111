...
<link rel="stylesheet" type="text/css" href="/Public/style/css/pager.css"></link>
  ...
  <div class="w_con"> 
   <h4 class="w_guide"><a href="/index/index">首页</a><a class="w_accord" href="/goods/glist">全部商品</a></h4> 
   <div class="w_goods_nav"> 
    <h2>全部商品<span>（共<a href="javascript:void%200"><?php echo ($zongji); ?></a>件商品）</span></h2> 
    <div class="w_choose"> 
	...
	$(".list_classMore").click(showh);
	 ...
	 <dl class="w_goods_brand"> 
		...
		<dd  class="w_specific_class1">
         ...
         <ul>
<li>
<a class="w_effect" href="/goods/glist/type/type/<?php echo ($cid); ?>_0_0.html">全部</a>
</li>
<?php if(is_array($two_cate_list)): foreach($two_cate_list as $key=>$two_cate): if($cid == $two_cate['cateid'] ): ?><li><a href="/goods/glist/type/<?php echo ($two_cate['cateid']); ?>_0_0.html" class="w_selected" title="<?php echo ($two_cate['name']); ?>"><?php echo ($two_cate['name']); ?></a></li>
       ...
       <dl class="w_goods_brand"> 
		...
		<dd id="ddBrandList_brand" class="w_specific_class1" ><?php endif; ?>
         <ul>
<li>
<a class="w_effect" href="/goods/glist/type/<?php echo ($cid); ?>_0_<?php echo ($order); ?>.html">全部</a>
</li>
...
<?php if(count($pinpai) > 17): ?><a class="list_classMore" href="javascript:;">展开<i></i></a><?php endif; ?>
        </dd> 
        <div class="w_clear"></div> 
       </dl> 
      </div> 
   ...
   <div class="w_product_con"> 
    <dl class="w_new"> 
     <dd>
      ...
      <dd>
      <a href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_1.html"  <?php if($order == '1'): ?>class="w_announced"<?php endif; ?> data-id="publicTime">即将揭晓</a>
     </dd> 
     <dd>
      <a href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_3.html"  <?php if($order == '3'): ?>class="w_announced"<?php endif; ?>  data-id="takedout">剩余人次</a>
     </dd> 
     <dd>
      <a href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_2.html"  <?php if($order == '2'): ?>class="w_announced"<?php endif; ?>  data-id="periods">热卖</a>
     </dd> 
     <dd>
      <a href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_4.html"  <?php if($order == '4'): ?>class="w_announced"<?php endif; ?> data-id="addTime">最新商品</a>
     </dd> 
     <dd>
      <?php if($order == '5'): ?><a class="w_last" href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_6.html" data-id="totalPrice_up">价格<span><img src="/Public/style/images/jia_03.png" /></span><span class="w_jian_tou"><img src="/Public/style/images/jia_06.png" /></span></a>
 <?php else: ?>
     <?php if($order == '6'): ?><a class="w_last" href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_5.html" data-id="totalPrice_up">价格<span><img src="/Public/style/images/jia_03.png" /></span><span class="w_jian_tou"><img src="/Public/style/images/jia_06.png" /></span></a>
      <?php else: ?>
            <a class="w_last" href="/goods/glist/type/<?php echo ($cid); ?>_<?php echo ($bid); ?>_5.html" data-id="totalPrice_up">价格<span><img src="/Public/style/images/jia_03.png" /></span><span class="w_jian_tou"><img src="/Public/style/images/jia_06.png" /></span></a><?php endif; endif; ?>
     </dd> 
    </dl> 
   </div> 
   <!--商品列表--> 
   ...
   <?php if(is_array($yyslist)): foreach($yyslist as $key=>$shop): ?><li class="w_goods_details ">
      ...
      </div><a class="w_goods_three" target="_blank" href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" data-gid="<?php echo ($shop['id']); ?>" data-pid="<?php echo ($shop['zongrenshu']); ?>" title="<?php echo ($shop['title']); ?>">(第<?php echo ($shop['qishu']); ?>期)<?php echo ($shop['title']); ?></a><b>价值：￥<?php echo ($shop['money']); ?></b>
      <div class="w_line">
      ...
      <dl class="w_rob">
       <dd>
        <a class="w_slip" target="_blank" href="/goods/items/goodsId/<?php echo ($shop['id']); ?>.html" data-gid="<?php echo ($shop['id']); ?>" data-pid="<?php echo ($shop['zongrenshu']); ?>">立即抢购</a>
       </dd>
       <dd class="w_rob_out">
        <a class="w_rob_in" href="javascript:void(0);" onclick="cartoong(<?php  echo $shop['id'].",".$ii;$ii++; ?>)">加入购物袋</a>
       </dd>
      </dl>
