            ...
            <form name="myform" action="" method="post" enctype="multipart/form-data">
                <table width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input name="reg_email" type="checkbox" value="1" <?php echo (C('reg_email') ? 'checked' : ''); ?> /> 邮箱注册 </label><br/>
                            <label><input name="reg_mobile" type="checkbox" value="1" <?php echo (C('reg_mobile') ? 'checked' : ''); ?> /> 手机注册 </label><br/>                  
                        </td>
                    </tr>
                    <tr>
                        <td width="120" align="right">单IP每日注册:</td>
                        <td>
                            <input name="reg_num" type="text" class="input-text" value="<?php echo C('reg_num');?>" /> 个<br/>                              
                        </td>
                    </tr>
                    <tr>
