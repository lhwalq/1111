...
<!--content left end-->
    ...
    <script type="text/javascript" src="/Public/piyungou/js/data.js"></script>
    <style type="text/css"> 
...
<div class="subMenu">
<?php if($biaoti == '编辑个人资料'): ?><a class="current2 current" href="/user/userModify"> <?php else: ?><a class="current2" href="/user/userModify"><?php endif; ?>个人资料</a>
<?php if($biaoti == '修改头像'): ?><a class="current" href="/user/userphoto"> <?php else: ?><a href="/user/userphoto"><?php endif; ?>修改头像</a>
	<?php if($biaoti == '收货地址'): ?><a class="current" href="/user/address"><?php else: ?><a href="/user/address"><?php endif; ?>收货地址</a>
<?php if($biaoti == '密码修改'): ?><a class="current" href="/user/password"><?php else: ?><a href="/user/password"><?php endif; ?>密码修改</a>
</div>


        <?php if($count == 0): ?><div  class="addAddress">
                <dl>添加收货地址</dl>
                <form class="registerform" method="post" action="/user/useraddress">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select datatype="*" nullmsg="请选择有效的省市区" id="hometown" runat="server" name="xian"></select>
        ...
        <?php if($count > 0): ?><div id="addressListDiv" class="list-tab detailAddress gray01" style="">
                ...
                <?php if(is_array($huiyuan_dizhi)): foreach($huiyuan_dizhi as $key=>$v): ?><ul class="liBg">
                        ...
                        <li class="wid70" id="listqq_<?php echo ($v['id']); ?>"><?php echo ($v['qq']); ?></li>

                        <?php if($v['default'] == 'Y'): ?><li class="wid80 orange">
                                默认地址
                            ...
                            <li class="wid80 lightBlue">
                                <a class="blue" href="/user/morenaddress/id/<?php echo ($v['id']); ?>">设为默认地址</a>
            ...
            <div class="add">
                <input id="btnAddnewAddr" type="button" class="orangebut" value="新增收货地址" style="display: block;">
            </div><?php endif; ?>
        <?php if($count <= 5): ?><div id="div_consignee" class="addAddress" style="display:none;">
                <dl>添加收货地址</dl>
                <form class="registerform" method="post" action="/user/useraddress">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select datatype="*" nullmsg="请选择有效的省市区" id="hometown2" runat="server" name="xian"></select>
                                    <em id="ship_address_valid_msg" class="red">*</em> 	
                                    <script type="text/javascript">
                                        init("province2", "", "city2", "", "hometown2", "");
                                    </script>
                                </td>
                                <td><div class="Validform_checktip"></div></td>
                            </tr>
        ...
        <div id="div_consignee2" class="addAddress" style="display:none;">
            <dl>修改收货地址</dl>
            <form id="registerform3" class="registerform3" method="post" >
                    ...
                    <tbody>
                        <tr>		
                            ...
                            <td>
                                ...
                                <select datatype="*" nullmsg="请选择有效的省市区" id="hometown3" runat="server" name="xian"></select>
                                <em id="ship_address_valid_msg" class="red">*</em> 	
                            </td>
                            <td><div class="Validform_checktip"></div></td>
                        </tr>
...
//    });
    ...
    $("#div_consignee2").show;
    // setup3();
    init("province3", "", "city3", "", "hometown3", "");
    $("#registerform3").attr("action", "/user/updateddress/id/" + id);
    ...
    $("#hometown3").append('<option selected value="' + spl[1] + '">' + spl[1] + '</option>');
    $("#dizh2").val(spl[3]);
    ...
    window.location.href = "{LOCAL_PATH}/member/home/deladdress/" + id;
    }
    }
