...
<!--content left end-->
<link rel="stylesheet" type="text/css" href="/Public/piyungou/css/layout-topic.css"/>
<div class="R-content">
	<div class="subMenu">
		<a class="current"><?php echo (L("web_setting_yes_shai")); ?></a>
		<a ><?php echo (L("web_setting_no_shai")); ?></a>
	</div>
	<div class="list-tab topic" style="display: block;">
		<ul class="listTitle">
			<li style="text-align:center;" class="w100"><?php echo (L("web_setting_shai_pic")); ?></li>
			<li class="w400"><?php echo (L("web_setting_shai_xinxi")); ?></li>
			<li class="w130"><?php echo (L("web_setting_shai_state")); ?></li>
			<li class="w85 fr"><?php echo (L("web_cart_chaozuo")); ?></li>
		</ul>
		
		<?php if($shaidan == null): ?><div class="tips-con"><i></i><?php echo (L("web_setting_no_record")); ?>！</div>
		<?php else: ?>
		
		<?php if(is_array($shaidan)): foreach($shaidan as $key=>$sd): ?><ul class="listCon">			
			<?php
 if($sd['shenhe']!=1){ ?>
					<li class="w100" style="text-align:center;"><a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>" target="_blank" class="blue"><img width="50" src="/Public/uploads/<?php echo ($sd['sd_thumbs']); ?>"/></a></li>
					<li class="w400"><a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>" target="_blank" class="gray01"><?php echo ($sd['sd_title']); ?></a></li>
					<li class="w130" style='color:red'><?php echo (L("web_setting_audit_ing")); ?>...</a></li>
					<li class="w85 fr"><font color="#666"><?php echo (L("web_setting_no_change")); ?></font></li>
			<?php
 }elseif($sd['shenhe']!=0){ ?>
					<li class="w100" style="text-align:center;"><a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>" target="_blank" class="blue"><img width="50" src="/Public/uploads/<?php echo ($sd['sd_thumbs']); ?>"/></a></li>
					<li class="w400"><a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>" target="_blank" class="gray01"><?php echo ($sd['sd_title']); ?></a></li>
					<li class="w130" style='color:green'><?php echo (L("web_setting_audit_go")); ?></a></li>
					<li class="w85 fr"><font color="#666"><?php echo (L("web_setting_no_change")); ?></font></li>
			<?php
 }else{ ?>
					<li class="w100" style="text-align:center;"><a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>" target="_blank" class="blue"><img width="50" src="/Public/uploads/<?php echo ($sd['sd_thumbs']); ?>"/></a></li>
	...
	<div class="list-tab topic" style="display: none;">
		<ul class="listTitle">
			<li style="text-align:center;" class="w100"><?php echo (L("web_setting_goods_pic")); ?></li>
			<li class="w630"><?php echo (L("web_setting_goods_detail")); ?></li>
			<li class="w85 fr"><?php echo (L("web_cart_chaozuo")); ?></li>
		</ul>
		
		<?php if($record == null): ?><div class="tips-con"><i></i><?php echo (L("web_setting_no_record")); ?>！</div>
		
		<?php else: ?>
		
		<?php if(is_array($record)): foreach($record as $key=>$sd): ?><ul class="listCon">
			<li style="text-align:center;" class="w100"><div class="listConT"><img width="50" src="/Public/uploads/<?php echo R('Base/shoplisext',array($sd['shopid'],'thumb'));?>"/></div></li>
			<li style="text-indent:1em;" class="w400"><a href="/goods/items/goodsId/<?php echo ($sd['shopid']); ?>.html" target="_blank"><?php echo R('Base/shoplisext',array($sd['shopid'],'title'));?></a></li>
			<li class="w50 fr"><a name="delete" href="/user/singleinsert/id/<?php echo ($sd['shopid']); ?>" class="blue"><?php echo (L("web_setting_add_shai")); ?></a></li>
		</ul><?php endforeach; endif; endif; ?>
	<?php
if(isset($_GET['p'])){ $fenyenum=$_GET['p']; }else{ $fenyenum=1; } $xx=ceil($zongji/10); ?>

<?php if( $fenyenum > 1): ?><a class="pageUp"  href="/user/home/singlelist?p=<?php echo ($fenyenum-1); ?>"><?php echo (L("web_setting_previou")); ?></a>
<?php else: ?>
<!-- <a class="pageUp w_page_in" >上一页</a> --><?php endif; ?>

<?php if(is_array($fenyenum)): foreach($fenyenum as $key=>$xx): ?><a class="pageDown"  href="/user/home/singlelist?p=<?php echo ($fenyenum+1); ?>"><?php echo (L("web_setting_next")); ?></a><?php endforeach; endif; ?>
</div>
</div>
...
#w3foucs #foucs_close{
	...
	right:10px;
	top:10px;
	background: url() -80px -70px no-repeat;
	display: block;
	cursor: pointer;
}
#w3foucs #page_close{
...
.PopMsgC s {
	background:url() -57px -96px no-repeat;
...
function shaidan(id){
	if(confirm("您确认要删除该条信息吗？")){
		window.location.href="/shaidandel/id/"+id;
	}
