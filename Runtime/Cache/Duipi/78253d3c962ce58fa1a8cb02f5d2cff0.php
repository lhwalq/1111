...
<div class="ygRecord">
    <h3><span><?php echo (L("web_index_history")); ?></span><p><a href="/index/buyrecordbai"><?php echo (L("web_index_look_new")); ?>&gt;&gt;</a></p></h3>
    <div class="border"></div>
    <div class="RecordSearch">
        <form action="" method="post">
            <div class="from">
                <p><?php echo (L("web_index_start_time")); ?></p>
                ...
                <p><?php echo (L("web_index_fen")); ?>&nbsp;&nbsp;&nbsp;<?php echo (L("web_index_zhi")); ?></p>
            </div>        
            <div class="over">
                ...
                <p><?php echo (L("web_index_fen")); ?></p>
            </div>
            <input id="btnQuery" class="Recordcx" value="<?php echo (L("web_index_select")); ?>"  name="dosubmit" type="submit">
