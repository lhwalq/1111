...
<!-- 导航   end  --> 
  <div class="w_header_nav">
   <img src="/Public/style/images/share_02.jpg" />
  </div> 
  <div class="w_con"> 
   <h2 class="w_title"><?php echo (L("web_shaidan_all")); ?><b>（<?php echo (L("web_shaidan_gong")); echo ($zongji); echo (L("web_shaidan_tiao")); ?>）</b></h2>
   <div class="w_share"> 
    <!--第一列--> 
    <dl class="w_share_one">
<?php if(is_array($shaidingdan)): foreach($shaidingdan as $key=>$sd): ?><dd class="w_oneself_share">
      <a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>"><img style="display: inline;" src="/Public/uploads/<?php echo ($sd['sd_thumbs']); ?>" class="lazy1" data-original="/Public/uploads/<?php echo ($sd['sd_thumbs']); ?>" />
       <noscript>
        <img src="/Public/uploads/<?php echo ($sd['sd_thumbs']); ?>" />
       </noscript></a>
      <p title="<?php echo ($sd['sd_title']); ?>" style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;display:block;"><?php echo ($sd['sd_title']); ?><br /><?php echo (date("Y-m-d H:i",$sd['sd_time'])); ?></p>
      <div class="w_single">
       <a href="/user/uname/d/<?php echo R('base/idjia',array($sd['sd_userid']));?>.html" class="w_em">
        <div class="w_f1">
         <img src="/Public/uploads/<?php echo R('base/huode_user_key',array($sd['sd_userid'],'img','3030'));?>" />
        </div><em><?php echo R('base/huode_user_name',array($sd['sd_userid'],'username'));?></em></a>
       <a href="/index/detail/id/<?php echo ($sd['sd_id']); ?>">(<?php echo ($sd['sd_ping']); ?>)</a>
      </div>
