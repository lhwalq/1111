...
<!-- 导航   end  --> 
<meta name="description" content="最新100条云购记录"><meta name="keywords" content="最新100条云购记录">
<link rel="stylesheet" type="text/css" href="/Public/piyungou/css/Comm.css">
...
<div class="ygRecord">
    <h3>
        <span><?php echo (L("web_index_new")); ?></span><p><?php echo (L("web_index_new_page")); ?><strong>100</strong><?php echo (L("web_index_tiao")); ?> <a href="/index/buyrecord"><?php echo (L("web_index_look_new")); ?>&gt;&gt;</a></p>
    </h3>
    <ul class="Record_title">
        <li class="time"><?php echo (L("web_index_cloud_time")); ?></li>
        <li class="nem"><?php echo (L("web_index_cloud_account")); ?></li>
        <li class="name"><?php echo (L("web_index_cloud_goods")); ?></li>
        <li class="much"><?php echo (L("web_index_cloud_num")); ?></li>
    </ul>
    <div id="recordList">
        <?php $n=1; ?> 
            ...
            <ul class="<?php echo ($class); ?>">
                ...
                <li class="name"><a href="/goods/items/goodsId/<?php echo ($Record['shopid']); ?>.html">（<?php echo (L("web_user_di")); echo ($Record['shopqishu']); echo (L("web_user_qi")); ?>）<?php echo R("Base/strcut",array($Record['shopname'],60,null));?></a></li>
                <li class="much"><?php echo ($Record['gonumber']); echo (L("web_lottery_person")); ?></li>
            </ul><?php endforeach; endif; ?> 

    </div>
    <div class="endpage"><?php echo (L("web_index_new_page")); ?><strong>100</strong><?php echo (L("web_index_tiao")); ?> <a href="/index/buyrecord" rel="nofollow"><?php echo (L("web_index_look_history")); ?>&gt;&gt;</a></div>
</div>
<style>
