...
<div class="Left-fixed-divs2 Left-fixed-divs3">
    ...
    <div class="fixed-divbottom">
        <p><?php echo (L("web_user_select")); ?><span id="row">0</span><?php echo (L("web_user_select")); ?><span class="yflr">￥<em id="hpriceTotal">0</em><?php echo (L("web_user_money")); ?></span></p>
...
<meta name="__hash__" content="0ad28d6f2def92ee63f099a0b706e55b_6bc9dd62c277aefb2d9e50bbceb94352" /></head>
<body>
<script type="text/javascript" src="/Template/default/js/jquery.min.js"></script>
 
<div class="clear"></div>
<div class="block" style=" background:#fee3c1; width:100%">
 
<style> 
.wrap{ width:1000px; margin:0 auto;}
.part1{ height:407px; background:url(/Public/images/part1-bg03.jpg) center top no-repeat;}
.part2{  height:367px; position:relative;background:url(/Public/images/part2-bg03.jpg) 50% 0 no-repeat;}
.part3{ position:relative; height:166px; color:#f9570b;background:url(/Public/images/part3-bg03.jpg) center top no-repeat;}
.part3 .wrap{ position:relative; height:166px;}
.part4{ height:385px; padding-top:25px; font-size:14px; background:url(/Public/images/part4-bg03.jpg) center top no-repeat;}
...
.activeRegulation i{  position:absolute; vertical-align:middle; top:3px; left:0; text-align:center; color:#fff; width:17px; height:17px; line-height:17px; background:url(/Public/images/rItem.png) no-repeat;}
...
.reg-txt {
 ...
 .login_button a {
    background: url('/Public/images/referrals_bg.png') no-repeat scroll 0% 0% transparent;
}
...
<div class="part4 ">
	...
	<dl class="activeRegulation fl">
		<dt><?php echo (L("web_pleasereg_rule")); ?>：</dt>
		<dd>
			<i><?php echo (L("web_pleasereg_one")); ?></i><?php echo (L("web_pleasereg_rule_one")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_pleasereg_two")); ?></i><?php echo (L("web_pleasereg_rule_two")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_pleasereg_three")); ?></i><?php echo (L("web_pleasereg_rule_three")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_pleasereg_four")); ?></i><?php echo (L("web_pleasereg_rule_four")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_pleasereg_five")); ?></i><?php echo (L("web_pleasereg_rule_five")); ?>
		</dd>
		<dd class="activeDetail tc"><a href="/user/login" target="_blank"><img src="/Public/images/activeDetail.png" alt=<?php echo (L("web_pleasereg_rule_detail")); ?>></a></dd>
	</dl>
	<!--活动规则 end-->
