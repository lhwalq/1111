                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tbody>				
                        ...
                        <tr>
                            ...
                            <td><?php echo $v['id']; ?></td>
                            <td><span  ><?php echo R('base/strcut',array($v['title'], 30));?></span>
                            ...
                            <td class="action">
                                <a href="/goods/goods_edit/id/<?php echo $v['id']; ?>">修改</a>
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tbody>				
                        ...
                        <tr>
                            ...
                            <td><?php echo $v['qishu']; ?>/<?php echo $v['maxqishu']; ?></td>          
                            <td class="action">			
                                [<a href="javascript:void(0)" gonemoney="<?php echo $v['yunjiage']; ?>" gmoney="<?php echo $v['money']; ?>" gqishu="<?php echo $v['maxqishu']; ?>" gid="<?php echo $v['id']; ?>" gtitle="<?php echo R('base/strcut',array($v['title'], 30));?>" class="pay_window_show">重设商品</a>]
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tbody>				
                        ...
                        <tr>
                            <td align='center'><input name='listorders[<?php echo $v['id']; ?>]' type='text' size='3' value='<?php echo $v['order']; ?>' class='input-text-c'></td>  
                            <td><?php echo $v['id']; ?></td>
                            <td><span  ><?php echo R('base/strcut',array($v['title'], 30));?></span></td>
                            <td><font color="#ff0000"><?php echo $v['canyurenshu']; ?></font> / <?php echo $v['zongrenshu']; ?></td>
                            <td><?php echo $v['yunjiage']; ?></td>
                            <td><?php echo $v['qishu']; ?>/<?php echo $v['maxqishu']; ?></td>
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="5%">排序</th>
                            <th width="5%">ID</th>        
                            <th width=<?php if (isset($yyslist[0]["is_choose"])) { ?> "20%"<?php } else { ?>"25%"<?php } ?> >商品标题</th>    
                            <th width="8%">所属栏目</th>             
                            <th width="10%">已参与/总需</th>
                            <th width="5%">单价/元</th>
                            <th width="10%">期数/最大期数</th>
                            <th width="5%">人气商品</th>
                            <th width="5%">广告商品(flash下)</th>
                            <th width="5%">限购</th>
                            <?php if (isset($yyslist[0]["is_choose"])) { ?> <th width="5%">选购</th><?php } else { } ?>
                            <th width="15%">管理</th>
                        </tr>
                    </thead>
                    <tbody>				
                        ...
                        <tr>
                            ...
                            <td><?php echo $v['qishu']; ?>/<?php echo $v['maxqishu']; ?></td>
                            <td><?php
 if ($v['renqi'] == 1) { echo '<font color="#ff0000">人气</font>'; } else { echo "<a href='/goods/goods_set/type/renqi/value/" . $v['id'] . "'>设为人气</a>"; } ?>
                            </td>
                            <td><?php
 if ($v['renqi1'] == 1) { echo '<font color="#ff0000">已设</font>'; } else { echo "<a href='/goods/goods_set/type/renqi1/value/" . $v['id'] . "'>设为广告</a>"; } ?>
                            </td>
                            <td><?php
 if ($v['fahuo'] == 1) { echo "<a href='/goods/goods_set/type/fahuo/value/" . $v['id'] . "'>已设</a>"; } else { echo "<a href='/goods/goods_set/type/fahuo1/value/" . $v['id'] . "'>限购</a>"; } ?>
                            </td>
                            <?php
 if (isset($yyslist[0]["is_choose"])) { if ($v['is_choose'] == 1) { echo "<td><a href='/goods/goods_set/type/xuangou/value/" . $v['id'] . "'>已设</a></td>"; } else { echo "<td><a href='/goods/goods_set/type/xuangou1/value/" . $v['id'] . "'>选购</a></td>"; } } ?>

                            <td class="action">
                                [<a href="/goods/goods_set_money/id/<?php echo $v['id']; ?>">重置价格</a>]  
                                [<a href="/goods/goods_edit/id/<?php echo $v['id']; ?>">修改</a>]              
                                [<a href="/goods/qishu_list/id/<?php echo $v['id']; ?>">查看往期</a>]
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
        ...
        <div class="btn_paixu">
            <div style="width:80px; text-align:center;">
                <input type="button" class="button" value=" 排序 "
                       onclick="myform.action = '/goods/goods_listorder/type/dosubmit';
                                               myform.submit();"/>
            </div>
        </div>
        ...
        <script>
            ...
            function set_shop_qishu(T) {
                ...
                $.post("/goods/goods_max_qishu/dosubmit/", {"gid": T, "qishu": tqishu, "money": money, "onemoney": onemoney}, function (datas) {
