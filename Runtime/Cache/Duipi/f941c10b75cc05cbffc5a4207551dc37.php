...
<!--				<span><a href="/uname/<?php echo R('base/idjia',array($huiyuan['uid']));?>.html" target="_blank" class="blue"><s></s>查看个人主页</a></span>-->
			...
			<!--</li>-->
			<li class="account-money">
				<em class="gray02"><?php echo (L("web_user_balance")); ?>：</em>
				<span class="money-red"><s></s><?php echo R("base/uidcookie",array("money"));?></span>&nbsp;&nbsp;
				<a href="/user/userrecharge" title=<?php echo (L("web_user_user_recharge")); ?> class="blue"><?php echo (L("web_user_user_recharge")); ?></a>
			</li>
			 <!--佣金邀请二维码<br>	-->
...
<!--<div class="right">-->
	<!--<div class="groups-shadow clearfix">-->
		...
		<!--<ul class="R-list">-->
                        <?php
 $tiezi=D("quan_tiezi")->where("hueifu!='0'")->order("hueifu DESC")->limit("8")->select(); $title=R("base/strcut",array(R("base/quanzid",array($tz['qzid'])),10)); ?>
                        <!--<?php if(is_array($dongtai)): foreach($dongtai as $key=>$tz): ?>-->
			<!--<li>-->
