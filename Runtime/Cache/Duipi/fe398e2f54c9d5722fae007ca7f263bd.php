			...
			<td valign="top" style="position: absolute;left: 100px;top: 210px;">
				<div class="bg222" style="position: relative;">
					<div id="marqueebox1" style="color: #FFC;">
						<ul>
                                                        <?php if(is_array($LotteryList)): foreach($LotteryList as $key=>$item): ?><li>【<?php echo R("Base/userid",array($item['uid'],'username'));?>***】：<?php echo (L("web_lottery_win")); echo ($item['title']); ?>，<?php echo (L("web_lottery_acquire")); echo ($item['desc']); ?>；</li><?php endforeach; endif; ?>
							<?php
...
#userrecharge a:hover{
	...
	<div id="userrecharge">
		<a href="/user/qiandao"><?php echo (L("web_lottery_happy_lot")); ?></a>
	</div>
...
<div class="part4 ">
	...
	<dl class="activeRegulation fl">
		...
		<dd>
			<i><?php echo (L("web_lottery_one")); ?></i><?php echo (L("web_lottery_rule_one")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_lottery_two")); ?></i><?php echo (L("web_lottery_rule_two")); ?>
					</dd>
		<dd>
			<i><?php echo (L("web_lottery_three")); ?></i><?php echo (L("web_lottery_rule_three")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_lottery_four")); ?></i><?php echo (L("web_lottery_rule_four_one")); ?>{fun:_yys('web_name_two')}<?php echo (L("web_lottery_rule_four_two")); ?>
		</dd>
		<dd>
			<i><?php echo (L("web_lottery_five")); ?></i><?php echo (L("web_lottery_rule_five")); ?>
		</dd>
	</dl>
    </div>
</div>
