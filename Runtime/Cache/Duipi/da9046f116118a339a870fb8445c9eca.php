...
<!--content left end-->
    <link rel="stylesheet" type="text/css" href="/Public/piyungou/css/layout-records.css"/>
    <div class="R-content">
        <div class="member-t"><h2><?php echo (L("web_setting_pokemon")); ?></h2></div>
        <div id="GoodsList" class="goods_show">
            <ul class="gtitle">
                <li><?php echo (L("web_setting_goods_pic")); ?></li>
                <li class="gname"><?php echo (L("web_setting_goods_name")); ?></li>
                <li class="yg_status"><?php echo (L("web_setting_fahuo_state")); ?></li>
                <li class="joinInfo"><?php echo (L("web_setting_mai_jian")); ?></li>
                <li class="do"><?php echo (L("web_cart_chaozuo")); ?></li>
            </ul>	

            <?php if(is_array($record)): foreach($record as $key=>$rt): $jiexiao =R("Base/huode_shop_if_jiexiao",array($rt['shopid'])); $shopid=$rt['shopid']; $jianginfo=D("shangpinzg")->where(array('id'=>$shopid))->find(); $status=explode(",",$rt['status']); ?>

                <ul class="goods_list">	
                    <li><a title="" target="_blank" class="pic" href="/goodszg/itemszg/goodsId/<?php echo ($rt['shopid']); ?>.html"><img src="/Public/uploads/<?php echo ($jianginfo['thumb']); ?>"></a></li>
                    <li class="gname"style="margin:10px 0 0 0;">
                        <a target="_blank" href="/goodszg/itemszg/goodsId/<?php echo ($rt['shopid']); ?>.html" class="blue"><?php echo ($rt['shopname']); ?></a>




                    </li>
                    <li class="yg_status" style="margin:23px 0 0 0;"><span class="orange"><?php echo ($rt['status']); ?>

                            <?php if(($status[1] == '已发货') ): ?><br>
                                <?php echo ($rt['company']); ?>---<?php echo (L("web_setting_numbers")); ?>:<?php echo ($rt['company_code']); endif; ?><br>

                            <?php if(($status[2] == '待收货') ): ?><a class="wuliubtn" oid="<?php echo ($rt[id]); ?>" uid="<?php echo ($rt[uid]); ?>"><?php echo (L("web_setting_yes_shouhuo")); ?></a><?php endif; ?>
                        </span></li>
                    <li class="joinInfo" style="margin:23px 0 0 0;"><p><em><?php echo ($rt['gonumber']); ?></em><?php echo (L("web_lottery_jian")); ?></p></li>


                    <?php if(($status[3] == '待收货') ): ?><li class="do" style="margin:23px 0 0 0;"><a  class="blue" title=<?php echo (L("web_setting_detail")); ?>><?php echo (L("web_setting_add_addr")); ?></a></li>

                        <?php else: ?>
                        <?php if(($status[2] == '待收货') ): ?><li class="do" style="margin:23px 0 0 0;"><a href="/user/orderDetailzg/id/<?php echo ($rt['id']); ?>" class="blue" title=<?php echo (L("web_setting_detail")); ?>><?php echo (L("web_setting_gogogo")); ?></a></li>
                            <?php else: ?>

                            <?php if(($status[2] == '已完成') ): ?><li class="do" style="margin:23px 0 0 0;"><a href="/user/orderDetailzg/id/<?php echo ($rt['id']); ?>" class="blue" title=<?php echo (L("web_setting_detail")); ?>><?php echo (L("web_setting_three_go")); ?></a></li>
                                <?php else: ?>
                                <li class="do" style="margin:23px 0 0 0;"><a href="/user/orderDetailzg/id/<?php echo ($rt['id']); ?>" class="blue" title=<?php echo (L("web_setting_detail")); ?>><?php echo (L("web_setting_add_addr")); ?></a></li><?php endif; ?>
                            <?php if(($status[3] == '未提交地址') ): ?><li class="do" style="margin:23px 0 0 0;"><a href="/user/orderDetailzg/id/<?php echo ($rt['id']); ?>" class="blue" title=<?php echo (L("web_setting_detail")); ?>><?php echo (L("web_setting_no_addr")); ?></a></li><?php endif; endif; endif; ?>
            ...
            <div id="divPageNav" class="page_nav">
                ...
                <?php echo $fenye->show('one');?> <li><?php echo (L("web_shaidan_gong")); ?> <?php echo ($zongji); ?> <?php echo (L("web_index_tiao")); ?></li>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function () {
        ...
        $(".wuliubtn").click(function () {
            ...
            $.post("/order/setzg", {"uid": uid, "oid": oid}, function (sdata) {
                if (sdata == '1') {
                    alert("更新成功");
                    window.location.href = "/user/userbuylistzg";
                } else {
                    alert("更新失败");
                }
            });
