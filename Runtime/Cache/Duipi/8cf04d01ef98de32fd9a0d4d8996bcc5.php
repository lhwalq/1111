...
<!-- 导航   end  -->
<div class="w_con">
    <div class="w_latest_title">
    <h2 class="w_title w_title_one">
	<a class="<?php if(empty($_GET[type])): ?>w_waiting<?php endif; ?>" href="/index/lottery"><?php echo (L("web_lottery_new")); ?></a>
<a class="<?php if($_GET[type] == 'd'): ?>w_waiting<?php endif; ?> w_last_waiting" href="/index/lottery/type/d"><?php echo (L("web_lottery_wait")); ?></a>
<a class="<?php if($_GET[type] == 'y'): ?>w_waiting<?php endif; ?> w_last_waiting" href="/index/lottery/type/y"><?php echo (L("web_lottery_already")); ?></a>
 <b>（<?php echo (L("web_lottery_so_far")); ?><c id="nameType"><?php echo (L("web_lottery_goods")); ?></c><output id="total"><?php echo ($zongji); ?></output><?php echo (L("web_lottery_jian")); ?>）</b>
    </h2>
    <h2 class="w_title w_title_two"><?php echo (L("web_lottery_unveiled")); ?><b></b></h2>
    </div>
    <div class="w_announced">
    	<div class="w_announced_one">
        	<?php if($_GET[type] == 'y'): ?><ul>
		<?php else: ?>
		<ul id='jiexiaog'><?php endif; ?>
                <?php if(is_array($yysqishu)): foreach($yysqishu as $key=>$qishu): $qishu['q_user'] = unserialize($qishu['q_user']); ?>
		<li class="w_latest">
   <div class="w_latestImg">
    <a class="w_goods_img" href="/goods/dataserverForPc/goodsId/<?php echo ($qishu['id']); ?>.html" target="_blank"><img style="display: inline;" src="/Public/uploads/<?php echo ($qishu['thumb']); ?>" class="lazy1" data-original="/Public/uploads/<?php echo ($qishu['thumb']); ?>" />
     <noscript>
      <img src="/Public/uploads/<?php echo ($qishu['thumb']); ?>" />
     </noscript></a>
   </div><a class="w_goods_three" href="/goods/dataserverForPc/goodsId/<?php echo ($qishu['id']); ?>.html" target="_blank">(<?php echo (L("web_user_di")); echo ($qishu['qishu']); echo (L("web_user_qi")); ?>)<?php echo ($qishu['title']); ?></a><b><?php echo (L("web_lottery_value")); ?>：<?php echo (L("web_lottery_mark")); echo ($qishu['money']); ?></b>
   <div class="w_different w_different_add">
    <div class="w_figure">
     <img style="display: inline;" src="/Public/uploads/<?php echo ($qishu['q_user']['img']); ?>" class="lazy20" data-original="/Public/uploads/<?php echo ($qishu['q_user']['img']); ?>" />
     <noscript>
      <img src="/Public/uploads/<?php echo ($qishu['q_user']['img']); ?>" />
     </noscript>
    </div>
    <dl class="w_text">
     <dd>
         <?php echo (L("web_lottery_gainer")); ?>：
      <a href="/user/uname/d/<?php echo R('base/idjia',array($qishu['q_uid']));?>.html"><?php echo R('base/huode_user_name',array($qishu['q_user']));?></a>
     </dd>
     
     <dd>
         <?php echo (L("web_lottery_lucky_num")); ?>：
      <i><?php echo ($qishu['q_user_code']); ?></i>
     </dd>
     <dd>
         <?php echo (L("web_lottery_partake")); ?>：
      <i><?php echo R('base/huode_user_goods_num',array($qishu['q_uid'],$qishu['id']));?></i>人次
     </dd>
     <dd>
         <?php echo (L("web_lottery_time")); ?>：<?php echo R('base/microt',array($qishu['q_end_time'],'r'));?>
     </dd>
     <dd class="w_add_multiple_box">
      <span class="w_add_multiple"><?php echo (L("web_lottery_roa")); ?>：<?php
 $shuzi= R('base/huode_user_goods_num',array($qishu['q_uid'],$qishu['id'])); echo $qishu['zongrenshu']/$shuzi; ?>
          <?php echo (L("web_lottery_bei")); ?></span>
      <a class="w_span w_span_other" href="/goods/dataserverForPc/goodsId/<?php echo ($qishu['id']); ?>.html" target="_blank"><?php echo (L("web_lottery_detail")); ?></a>
     </dd>
    </dl>
   </div>
   </li><?php endforeach; endif; ?>		
       		...
       		<?php if($zongji > $num ): ?><div class="pagesx"><?php echo $fenye->show("two"); ?></div><?php endif; ?></div>
       	</div>
       	<ul class="w_announced_two">  
	

	<?php if(is_array($yyslistji)): foreach($yyslistji as $key=>$list): ?><li class="w_latest_right"> 
   <div class="w_rightImg"> 
    <a class="w_goods_img" href="/goods/items/goodsId/<?php echo ($list['id']); ?>.html" target="_blank"> <img style="display: inline;" src="/Public/uploads/<?php echo R('base/shopimg',array($list['id']));?>" id="img_0" class="lazy200" data-original="/Public/uploads/<?php echo R('base/shopimg',array($list['id']));?>" /> 
     <noscript>
      <img id="img_0" src="/Public/uploads/<?php echo R('base/shopimg',array($list['id']));?>" />
     </noscript> </a> 
   </div> <a class="w_goods_three" href="/goods/items/goodsId/<?php echo ($list['id']); ?>.html" target="_blank">(<?php echo (L("web_user_di")); echo ($list['qishu']); echo (L("web_user_qi")); ?>)<?php echo ($list['title']); ?></a> <b><?php echo (L("web_lottery_all_has")); ?>：<?php echo ($list['zongrenshu']); ?> <?php echo (L("web_lottery_person")); ?></b>
   <div class="w_line">
    <span style="width:<?php echo R('base/width',array($list['canyurenshu'],$list['zongrenshu'],203));?>px;"></span>
   </div> 
   <ul class="w_number"> 
    <li class="w_amount"><?php echo ($list['canyurenshu']); ?></li> 
    <li class="w_amount w_amount_right"><?php echo ($list['zongrenshu']-$list['canyurenshu']); ?></li> 
    <li><?php echo (L("web_lottery_person_al")); ?></li>
    <li class="w_amount_right"><?php echo (L("web_lottery_residue")); ?></li>
   </ul> <input id="gid_0" value="628" type="hidden" /> <input id="pid_0" value="3" type="hidden" /> <input id="priceArea_0" value="1" type="hidden" /> <input id="period_0" value="" type="hidden" /> <input id="priceTotal_0" value="2969" type="hidden" /> <input id="surplus_0" value="294" type="hidden" /> <input id="thumbPath_0" value="20150727/2_1437990510407.jpg,20150727/2_1437990518024.jpg,20150727/2_1437990518528.jpg" type="hidden" /> <input id="title_0" value="<?php echo ($list['title']); ?>" type="hidden" /> <a class="w_package" href="/goods/items/goodsId/<?php echo ($list['id']); ?>.html"><?php echo (L("web_lottery_cloud")); ?></a>
   </li><?php endforeach; endif; ?>
...
<script type="text/javascript" src="/Public/piyungou/js/GLotteryFung.js"></script>
	                <script type="text/javascript">
						$(document).ready(function(){gg_show_time_initg("jiexiaog",'/',0);});	
