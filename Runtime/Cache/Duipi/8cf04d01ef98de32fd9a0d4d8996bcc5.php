...
<div class="w_con">
	...
	<a class="<?php if(empty($_GET[type])): ?>w_waiting<?php endif; ?>" href="/index/lottery">最新揭晓</a>
<a class="<?php if($_GET[type] == 'd'): ?>w_waiting<?php endif; ?> w_last_waiting" href="/index/lottery/type/d">等待揭晓</a>
<a class="<?php if($_GET[type] == 'y'): ?>w_waiting<?php endif; ?> w_last_waiting" href="/index/lottery/type/y">已经揭晓</a>
 <b>（到目前为止最新揭晓<c id="nameType">商品</c><output id="total"><?php echo ($zongji); ?></output>件）</b>
    </h2>
    <h2 class="w_title w_title_two">即将揭晓<b></b></h2>
    </div>
   ...
   </div><a class="w_goods_three" href="/goods/dataserverForPc/goodsId/<?php echo ($qishu['id']); ?>.html" target="_blank">(第<?php echo ($qishu['qishu']); ?>期)<?php echo ($qishu['title']); ?></a><b>商品价值：￥<?php echo ($qishu['money']); ?></b>
   <div class="w_different w_different_add">
    ...
    <dl class="w_text">
     ...
     <dd>
      揭晓时间：<?php echo R('base/microt',array($qishu['q_end_time'],'r'));?>
     </dd>
     <dd class="w_add_multiple_box">
      <span class="w_add_multiple">回报率：<?php  $shuzi= R('base/huode_user_goods_num',array($qishu['q_uid'],$qishu['id'])); echo $qishu['zongrenshu']/$shuzi; ?>
		   倍</span>
      <a class="w_span w_span_other" href="/goods/dataserverForPc/goodsId/<?php echo ($qishu['id']); ?>.html" target="_blank">查看详情</a>
     </dd>
    </dl>
   </div>
   </li><?php endforeach; endif; ?>		
   ...
   </div> <a class="w_goods_three" href="/goods/items/goodsId/<?php echo ($list['id']); ?>.html" target="_blank">(第<?php echo ($list['qishu']); ?>期)<?php echo ($list['title']); ?></a> <b>总需：<?php echo ($list['zongrenshu']); ?> 人次</b> 
   <div class="w_line">
