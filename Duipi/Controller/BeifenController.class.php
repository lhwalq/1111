...
class BeifenController extends BaseController {
    ...
    function index() {
        ...
        $ment = array(
            array("lists", "数据库备份", C("URL_DOMAIN") . "Beifen/tablist"),
            array("reg", "备份管理", C("URL_DOMAIN") . "Beifen/index"),
        );
