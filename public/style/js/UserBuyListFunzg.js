	...
	var e = function () {
		var h = function () {
			...
			var j = function () {
				...
				$.getJSON(roots+"/user/getUserBuyListNewzg"+i()
				, function (q) {
					if (q.code == 0) {
						if (a.isCount == 1) {
							b = q.count;
						...
						for (var r = 0; r < s; r++) {
							...
							if (m == 1) {
								...
								n += '<a href="javascript:;">';
								n += '<cite><img src="' + Gobal.loadpic + '" src2="/love/uploads/' + k.goodsPic + '" />' + (p[r].codeType == 3 ? '<div class="pPurchase"></div>' : "") + "</cite>";
								n += "<dl>";
								n += "<dt>" + k.goodsname + "</dt>";
								n += "<dd>";
								...
								n += '<li class="P-bar01"><em>' + t + "</em>销量</li>";
								
								n += '<li class="P-bar03"><em>' + l + "</em>库存</li>";
								n += "</ul>";
								n += "</div>";
								n += "</div>";
								n += "</dd>";
								...
								if (m == 2) {
									...
									n += '<cite><img src="' + Gobal.loadpic + '" src2="/love/uploads/' + k.goodsPic + '" />' + (p[r].codeType == 3 ? '<div class="pPurchase"></div>' : "") + "</cite>";
									n += "<dl>";
									n += "<dt>(第" + k.codeperiod + "期)" + k.goodsname + "</dt>";
									...
									if (m == 3) {
										...
										n += '<cite><a ><img src="' + Gobal.loadpic + '" src2="/love/uploads/' + k.goodsPic + '" /></a><i>已揭晓</i>' + (p[r].codeType == 3 ? '<div class="pPurchase">限购</div>' : "") + "</cite>";
										n += "<dl>";
										n += '<dt><a  class="gray6">(第' + k.codeperiod + "期)" + k.goodsname + "</a></dt>";
										n += '<dd>已参与<em class="orange">' + k.buynum + "</em>人次</dd>";
										n += '<dd>获得者：<a href="/mobile/mobile/userindex/' + k.q_uid + '" class="blue">' + k.username + "</a></dd>";
							...
							o.bind("click", function () {
								...
								var x = "http://yyygcms.cn/lottery/detail-" + $(this).attr("codeid") + "";
