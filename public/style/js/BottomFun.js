...
function scrollForLoadData(a) {
    ...
    Gobal.NoneHtmlEx = '<div class="noRecords colorbbb clearfix"><s></s>近期无记录<div class="z-use"></div></div>';
    ...
    var a = function() {
        ...
        if (e == "1" || e == "2" || e == "3") {
            ...
            if (e != "3") {
                ...
                g += '<a href="/mobile/mobile"><i class="home"></i>云购</a>';
                g += '<a href="/mobile/mobile/lottery"><i class="announced"></i>最新揭晓</a>';
                g += '<a href="/mobile/shaidan/"><i class="single"></i>晒单</a>';
                g += '<a href="/mobile/user/login"><i class="personal"></i>我</a>';
                g += "</div>"
            }
            g += "</div>";
            var l = $("#div_fastnav");
    ...
    Base.getScript(pub+"/JS/Comm.js?v=151105", a)
})();