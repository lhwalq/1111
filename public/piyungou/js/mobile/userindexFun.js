    ...
    var a = function() { 
        ...
        var g = function() {
            ...
            var v = function() {
				  ...
				  //alert(I.count)
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            ...
                            var z = Math.ceil(G);
                            E += "<ul onclick=\"location.href='/mobile/mobile/item/" + F.shopid + '\'"><li class="mBuyRecordL">';
                            E += '<img src2="/love/uploads/' + F.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                            E += '<li class="mBuyRecordR">(第' + F.qishu + "期)" + F.title + "";
                            if (F.codeState == 3) {
                                E += '<p class="mValue">价值：￥' + F.money + '</p><span>获得者：<a style="color: #22AAff" href="/mobile/mobile/userindex/' + F.q_uid + '">' + F.q_user + '</a><br>幸运一元云购码：<em class="orange">' + F.q_user_code + "</em></span>"
                            } else {
				...
				$.getJSON('/mobile'+"/ajax"+"/getUserBuyList/"+w(),y)
            };
                ...
                var y = function(z) {
                    ...
                    if (z.code == 0) {
                        ...
                        for (var A = 0; A < E; A++) {
                            ...
                            var C = D[A];
                            console.log(C)
                            B += "<ul onclick=\"location.href='/mobile/mobile/item/" + C.id + '\'" class="BuyRecordList"><li class="mBuyRecordL">';
                            B += '<img src2="/love/uploads/' + C.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                ...
                var y = function(H) {				 
                    if (H.code == 0) {
                        ...
                        for (var E = 0; E < D; E++) {
                            ...
                            F += '<li><a href="/mobile/shaidan/detail/' + G.sd_id + '"><h3><b>' + G.sd_title + "</b><em>" + G.sd_time + "</em></h3>";
                            F += "<p>" + z + "</p><dl>";
                            var A = G.sd_thumbs.split(",");
                            for (var C = 0; C < A.length; C++) {
                                F += '<img src2="/love/uploads/' + A[C] + '" src="' + Gobal.LoadPic + '">';
                                if (C >= 2) {
                                    break
                                }
                            }
