$(function() {
    ...
    (function(){
		...
		var html = '';
			...
			html += '		<img  src="' + Gobal.imgpath + '/uploads/' + info.thumb + '"></li><a>';
		...
		var gid = '';
		var thread = function(){
			$.getJSON(Gobal.Webpath+"/api/getshop/lottery_shop_json/"+new Date().getTime(),{'mobile':true,'test':true,'gid':gid},function(info){
    ...
    Base.getScript(pub+"/js/Comm.js", k)
});