...
if(info.error == '0' && info.id != 'null' && info.q_user_code != 'null'&& info.q_user_code != ''){
			var uhtml = '';
						uhtml += '<a href="'+data['path']+'/mobile/mobile/item/'+info.id+'" target="_blank" class="u-lott-pic">';
							uhtml +='<img src="'+info.upload+'/'+info.thumb+'">';
						uhtml +='</a>';						
						uhtml +='<span class="winner">';
						uhtml+='恭喜<a class="blue z-user" href="'+data['path']+'/mobile/mobile/userindex/'+(1000000000 + parseInt(info.uid))+'" target="_blank">';
						uhtml+=info.user;
					uhtml+='</a>获得';
					uhtml+='</span>';
					}
