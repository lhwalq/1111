$(function() {
    var a = function() {	 
        ...
        var r = function() {
            ...
            var y = function() {
               ...
               // GetJPData("http://m.1yyg.com", "getUserRecharge", w(),
				 $.getJSON("/mobile"+"/shopajax"+"/getUserRecharge3"+w(),
                function(D) {
                    if (D.code == 0) {
                        var B = "";
                        if (v.isCount == 1) {
                            x = D.count;
                            v.isCount = 0;
							// B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span>红包卡号'+ C[z].title +'<br>密码'+ C[z].pwd +'<br>' + C[z].time1 + "至" + C[z].time2 +  "<br>满" + C[z].shuoming1 +  "减" + C[z].shuoming2 +  "<br>红包金额" + C[z].money +  "</span></li>"

                           B = '<li class="m-userMoneylst-tt"><span>红包信息</span></li>'
                        }
                        var C = D.listItems;
                        var A = C.length;
                        for (var z = 0; z < A; z++) {
        ...
        var t = function() {
            ...
            var y = function() {
                d.show();				
                $.getJSON("/mobile"+"/shopajax"+"/getUserConsumption3"+w(),
                function(D) {
                    if (D.code == 0) {
                        var B = "";
                        if (v.isCount == 1) {
