...
{	
	var iframe_str='<iframe frameborder="0" ';
		...
		iframe_str=iframe_str+'src="'+path+'tools/upload/';
		iframe_str=iframe_str+'title/'+title+'/type/'+type+'/dir/'+dir+'/num/'+num+'/size/'+size+'/frame/'+frame+'/input/'+input+'/func/'+func+'"';
