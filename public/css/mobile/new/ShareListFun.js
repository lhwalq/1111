$(function() {
    ...
    var a = function() {
        ...
        var r = function() {
            ...
            if (u()) {
                ...
                GetDominData("http://weixin.1yyg.com", "getpassportdata", "action=checkname&name=" + E, D)
            }
        };
        var f = function() {
            var E = B;
            ...
            m();
            GetDominData("http://weixin.1yyg.com", "getpassportdata", "action=ECUP&userMobile=" + E, D)
        };
        var B = "";
        var u = function() {
            B = w.val();
            ...
            if (u()) {
                ...
                if (E == "" || E == s.txtCodeStr) {
                    ...
                    if (!p(E)) {
                        ...
                        GetDominData("http://weixin.1yyg.com", "getpassportdata", "action=verifymobilesn&mobile=" + w.val() + "&sn=" + E, D)
                    }
                }
            }
        };
    ...
    Base.getScript(pub+"/JS/pageDialog.js?v=140917",
    function() {
        a();
        d()
    })
