    ...
    var e = function () {
        ...
        var k = function () {
            ...
            var s = function (w, v, u) {
                w.addClass("add");
                $.getJSON(roots + "/Goodszg/addShopCartzg", "codeid=" + v + "&shopNum=" + u,
                        function (x) {
                            if (x.code == 0) {
            ...
            var t = function () {
                $.getJSON(roots + "/Goodszg/getGoodsPageListzg/", r(),
                        function (y) {
                            //alert(y.code);
                            if (y.code == 0) {
                                var x = y.listItems;
                                ...
                                for (var z = 0; z < A; z++) {
                                    ...
                                    v += '<img src="' + Gobal.LoadPic + '" src2="' + pub + '/uploads/' + w.goodspic + '" />';
                                    if (w.goodstag == 10) {
                                    ...
                                    v += '<em class="gray9">价值：￥' + CastMoney(w.yunjiage);
                                    v += "</em>";
                                    v += '<div class="gRate">';
                                    v += '<div class="Progress-bar">';

                                    v += '<ul class="Pro-bar-li">';
                                    v += '<li class="P-bar01"><em>' + B + "</em>销量</li>";
                                    v += '<li class="P-bar03"><em>' + u + "</em>库存</li>";
                                    v += "</ul>";
                                    v += "</div>";
                                    ...
                                    var C = $(v);
                                    C.click(function () {
                                        location.href = roots + "/Goodszg/itemszg/goodsId/" + $(this).attr("id")
