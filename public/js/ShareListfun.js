$(function() {
    ...
    var e = function() {
        ...
        if (_RID > 0) {
            ...
            var f = function(j) {
                try {
                    if (j.urls[0].result) {
                        ...
                        var l = j.urls[0].url_short.replace("t.cn", "m10.yyygcms.cn");	
            ...
            $.getJSON(roots+"/mobile/getshorturl", "url=" + escape("" + g()), f)
        }
        var h = $("#hidLineLink").val();
		var im = $("#hidLineimg").val();
    ...
    var c = function() {
        ...
        $("#liMention").click(function() {
            if (f >= 100) {
                location.href = roots+"/invite/cashout";
            } else {
                b("佣金满100才可提现哦")
            }
        });
        $("#liRechagre").click(function() {
            if (parseInt(f) > 0) {
                ...
                $("#btnOK").click(function() {
                    $.getJSON(roots+"/user/memberCenterApplyToAccount", "",
                    function(l) {
                        if (l.code == 0) {
                            f = f - l.money;
                            $("div.f-pop-balance").remove();
