/*
  kkpager1 V1.3
  https://github.com/pgkk/kkpager1
...
var kkpager1 = {
		...
		click	: function(n){
			//这里自己实现
			//这里可以用this或者kkpager1访问kkpager1对象
			return false;
		},
		...
		generPageHtml : function(config,enforceInit){
			...
			if(this.isGoPage){
				gopage_info = '<span class="goPageBox">'+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'">'+
					'<input type="text" id="'+this.gopageTextboxId+'"  onkeypress="return kkpager1.keypress_gopage(event);" value="'+this.next+'" /></span>'+this.lang.gopageAfterText+'</span>'+
					'<input type="button" id="'+this.gopageButtonId+'" onclick="kkpager1.gopage()" value="'+this.lang.gopageButtonOkText+'" />';
			}
