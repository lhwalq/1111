$(function () {
    var reg = new RegExp("(^|&)" + "glist" + "=([^&]*)(&|$)"); //构造一个含有目标参数的正则表达式对象
    var rs = window.location.search.substr(1).match(reg);  //匹配目标参数
    var glist = rs ? unescape(rs[2]) : "";   
    var g = null;
    var h = $("div.goodList");
    var d = $("#divLoading");
    var b = 60;
    ...
    var e = function () {
        ...
        var k = function () {
            var r = function () {
                return "sortid=" + a.sortid + "&brandID=" + a.brandID + "&orderFlag=" + a.orderFlag + "&fIdx=" + a.fIdx + "&eIdx=" + a.eIdx + "&isCount=" + a.isCount + "&glist=" + a.glist;
            };
            var m = false;
            var q = false;
            var p = function (v, u) {
