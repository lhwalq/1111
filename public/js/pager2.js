/*
  kkpager2 V1.3
  https://github.com/pgkk/kkpager2
...
var kkpager2 = {
		...
		hrefFormer			: '', //链接前部
		hrefLatter			: '', //链接尾部
		gopageWrapId		: 'kkpager2_gopage_wrap',
		gopageButtonId		: 'kkpager2_btn_go',
		gopageTextboxId		: 'kkpager2_btn_go_input',
		lang				: {
			firstPageText			: '首页',
			firstPageTipText		: '首页',
			lastPageText			: '尾页',
		...
		click	: function(n){
			//这里自己实现
			//这里可以用this或者kkpager2访问kkpager2对象
			return false;
		},
		...
		generPageHtml : function(config,enforceInit){
			...
			if(this.isGoPage){
				gopage_info = '<span class="goPageBox">'+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'">'+
					'<input type="text" id="'+this.gopageTextboxId+'"  onkeypress="return kkpager2.keypress_gopage(event);" value="'+this.next+'" /></span>'+this.lang.gopageAfterText+'</span>'+
					'<input type="button" id="'+this.gopageButtonId+'" onclick="kkpager2.gopage()" value="'+this.lang.gopageButtonOkText+'" />';
			}
