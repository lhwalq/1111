$(function () {
    ...
    var e = function () {
        var h = function () {
            ...
            var j = function () {
                $.getJSON(roots + "/user/getMemberCenterUserWinList", i(),
                        function (p) {
                            if (p.code == 0) {
                                if (a.isCount == 1) {
                                    d = p.totalCount;
                                ...
                                var l = function (w, v) {
                                    ...
                                    if (s == 0) {
                                        if (o[q].yuanjia != "")
                                        {
                                            u += '<dd><a href="'+roots+'/user/orderdetail/crodid/' + o[q].codeID + '" class="orangeBtn">完善收货地址</a><a href="'+roots+'/user/excorderdetail/id/' + o[q].codeID + '"  class="orangeBtn">兑换积分</a></dd>'

                                        } else {
                                            u += '<dd><a href="'+roots+'/user/orderdetail/crodid/' + o[q].codeID + '" class="orangeBtn">完善收货地址</a></dd>'

                                        }
                                    } else {
                                        if (s == 1) {
                                            u += '<dd><a href="orderdetail/crodid/' + o[q].orderNo + '" class="grayBtn">待发货</a></dd>'
                                        } else {
                                            if (s == 2) {
                                                ...
                                                if (s == 3) {
                                                    ...
                                                    if (s == 4) {
                                                        if (parseInt(o[q].IsPostSingle) == 0) {
                                                            ...
                                                            if (v == 0) {
                                                                u += '<dd><a href="'+roots+'/user/singleinsert/id/' + o[q].codeIDs + '" class="orangeBtn">晒单赢福分</a></dd>'
                                                            }
                                                        }
                                                    } else {
                                                        if (s == 11) {
                                ...
                                for (var q = 0; q < r; q++) {
                                    ...
                                    if (k == 0) {
                                        ...
                                        m += '<img src="' + Gobal.LoadPic + '" src2="' + pub + '/uploads/' + o[q].goodsPic + '" />';
                                    ...
                                    n.bind("click",
                                            function () {
                                                if ($(this).attr("orderType") == "2") {
                                                    ...
                                                    location.href = roots+"/goods/dataserver/goodsId/" + $(this).attr("codeIDs")
                                                }
                                            });
                                    b.append(n)
                                }
