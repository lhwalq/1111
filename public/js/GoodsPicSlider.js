    ...
    a.picslider = function(e, c) {
        ...
        b = {
            init: function() {
                ...
                var i = a("#PicPostion").find("dd");
                if (i.length > 0) {
                    i.eq(0).addClass("hover").siblings().removeClass("hover")
                }
            },
            directionNav: {
                setup: function() {
