$(function() {
   // var b = "http://passport.1yyg.com";
            ...
            if (u == "" || u == h.txtStr) {
                ...
                if (!m(u)) {
                    ...
                    var t = function(v) {
                        if (v.state == 0) {
						    e(h.sucess);
							location.href = roots+"/mobile/index";					
                            return
                        } else {
                            e(h.outtime);
					...
					$.getJSON(roots+ "/user/mobileregsn/mobile/"+o+"/code/"+ u, t);
                }
            }
        };
        var k = function() {
            ...
            isLoaded = false;
                        $.getJSON(roots+ "/user/sendmobileAjax/code/"+o, t)
        };
        var s = function() {
            var v = n;
    ...
    Base.getScript(pub+"/js/mobile/pageDialog.js", a)
});