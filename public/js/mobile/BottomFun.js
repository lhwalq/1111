...
var addNumToCartFun = null; (function() {
   // Gobal.Skin = "http://mskin.1yyg.com";
    ...
    Gobal.Skin = "localhost"; 
    Gobal.Webpath = "100"; 
    Gobal.imgpath = "public";  //上传图片地址
    
    Gobal.LoadImg = null;
    Gobal.LoadHtml = '<div class="loadImg">正在加载</div>';
    Gobal.LoadPic = "/style/images/loading.gif";
    ...
    function(h) {       
        var g = '<span><a href='+Gobal.Webpath+'/mobile/mobile/about>新手指南</a><b></b></span>';
        if (h.code == 0) {		   
