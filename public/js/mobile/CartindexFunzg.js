    ...
    var b = function () {
        ...
        if (h.length > 0) {
            h.children("a").click(function () {
                location.href = roots + "/Payzg/payzg";   //付款页面
            })
        }
            ...
            var s = function (w) {
                ...
                if (w.code == 1) {
                    ...
                    if (w.code == 4) {
                        ...
                        q.parent().prev().html('总共购买：<em class="arial">' + r + '</em>人次/<em class="orange arial">￥' + r * yunjiage + ".00</em>")
                    }
                }
            };
            $.getJSON(roots + "/goodszg/addShopCart/codeid/" + t + "/shopNum/" + r + "/from/cart", s)
            ...
            $(this).bind("click",
                    function () {
                        ...
                        var s = function () {
                            ...
                            $.getJSON(roots + "/goodszg/delCartItem/codeid/" + t, u);
                        };
                        n("您确定要删除吗？", s)
                    })
        })
