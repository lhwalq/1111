        ...
        var k = function() {
            ...
            var s = function(w, v, u) {
               ...
               // GetJPData("http://weixin.1yyg.com", "addShopCart", "codeid=" + v + "&shopNum=" + u,
					 $.getJSON("/mobile/ajax/"+ "addShopCart", "codeid=" + v + "&shopNum=" + u,     
                function(x) {
                    if (x.code == 0) {
            ...
            var t = function() {
                $.getJSON(roots+ "/Area/getAreaPageList", r(),
                function(y) {
					//alert(y.code);
                    if (y.code == 0) {
                        var x = y.listItems;
                        ...
                        for (var z = 0; z < A; z++) {
                            ...
                            v += '<ul id="' + w.goodsid + '">';
                            v += "<li>";
                            v += '<div><span class="gList_larea1">';
                            v += '<img src="' + Gobal.LoadPic + '" src2="' + w.goodspic + '" width="95%"/>';
                            if (w.goodstag == 10) {
                                v += '<div class="pTitle pPurchase">限购</div>'
                            }
                            v += "</span></div>";
                            v += '<div class="gList_r1">';
                            v += '<h3 class="gray6">'  + w.goodssnme + "</h3>";
							v += '<p>房间号：' + w.arid + "</p>";
                            /*v += '<div class="gRate" style="margin-top:-32px;">';
                            v += '<div class="Progress-bar">';
                            v += '<p class="u-progress"><span style="width: ' + E + '%;" class="pgbar"><span class="pging"><img src="/love/templates/yungou/images/mobile/bling.png" class="bling"></span></span></p>';
                            ...
                            C.click(function() {
                                //alert(roots);
                                location.href = "/mobile/areacheck/id/" + $(this).attr("id") 
