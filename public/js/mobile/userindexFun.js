    ...
    var a = function() { 
		...
		y += "/Type/" + x.Type;
            ...
            var v = function() {
				  ...
				  //alert(I.count)
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            ...
                            var z = Math.ceil(G);
                            E += "<ul onclick=\"location.href='"+roots+"/goods/items/goodsId/" + F.shopid + '\'"><li class="mBuyRecordL">';
                            E += '<img src2="'+pub+'/uploads/' + F.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                            E += '<li class="mBuyRecordR">(第' + F.qishu + "期)" + F.title + "";
                            if (F.codeState == 3) {
                                E += '<p class="mValue">价值：￥' + F.money + '</p><span>获得者：<a style="color: #22AAff" href="'+roots+'/mobile/userindex/id/' + F.q_uid + '">' + F.q_user + '</a><br>幸运一元云购码：<em class="orange">' + F.q_user_code + "</em></span>"
                            } else {
                        ...
                        if (I.code == 1) {
                            ...
                            if (I.code == 2) {
                                m.append('<div class="haveNot z-minheight"><s></s><p>TA未有公开的一元云购记录哦</p></div>')
                            } else {
                                m.append(s);
                                BuyRecordFun.CountFalg = false
                            }
				...
				$.getJSON(roots+"/mobile/getUserBuyList"+w(),y)
            };
                ...
                var y = function(z) {
                    ...
                    if (z.code == 0) {
                        ...
                        for (var A = 0; A < E; A++) {
                            ...
                            var C = D[A];
                            console.log(C)
                            B += "<ul onclick=\"location.href='"+roots+"/goods/items/goodsId/" + C.id + '\'" class="BuyRecordList"><li class="mBuyRecordL">';
                            B += '<img src2="'+pub+'/uploads/' + C.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                            B += '<li class="mBuyRecordR">(第' + C.qishu + "期)" + C.title + '<p class="mValue">价值：￥' + C.money + "</p>";
                            B += '<span>幸运一元云购码：<em class="orange">' + C.q_user_code + "</em><br>揭晓时间：" + C.q_end_time + " </span></li></ul>"
                        }
                        e.append(B);
                        s = "";
                        loadImgFun();
                ...
                var y = function(H) {				 
                    if (H.code == 0) {
                        ...
                        for (var E = 0; E < D; E++) {
                            ...
                            F += '<li><a href="'+roots+'/mobile/detail/id/' + G.sd_id + '"><h3><b>' + G.sd_title + "</b><em>" + G.sd_time + "</em></h3>";
                            F += "<p>" + z + "</p><dl>";
                            var A = G.sd_thumbs.split(",");
                            for (var C = 0; C < A.length; C++) {
                                F += '<img src2="'+pub+'/uploads/' + A[C] + '" src="' + Gobal.LoadPic + '">';
                                if (C >= 2) {
                                    break
                                }
                            }
