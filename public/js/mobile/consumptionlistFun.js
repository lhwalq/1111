$(function () {
    var a = function () {
        ...
        var r = function () {
            ...
            var w = function () {
                return "/FIdx/" + v.FIdx + "/EIdx/" + v.EIdx + "/isCount/" + v.isCount
            };
            var y = function () {
                d.show();
                $.getJSON(roots + "/user/getUserRecharge" + w(),
                        function (D) {
                            if (D.code == 0) {
                                var B = "";
                                if (v.isCount == 1) {
        ...
        var t = function () {
            ...
            var y = function () {
                ...
                $.getJSON(roots + "/user/getUserConsumption" + w(),
                        function (D) {
                            if (D.code == 0) {
                                var B = "";
                                if (v.isCount == 1) {
                                ...
                                var A = C.length;
                                for (var z = 0; z < A; z++) {
                                    B += '<li class="' + (z + 1 == A ? "bornone" : "") + '"><span>' + C[z].time + "</span><span>￥" + C[z].money + C[z].content + "</span></li>"
                                }
                                if (v.FIdx > 0) {
