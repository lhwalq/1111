    ...
    var b = function() {
        ...
        var q = function(y) {
            ...
            if (y > 0) {
                ...
                c.attr("sel", "1").attr("class", "z-pay-mentsel").next("span").html('潮购币支付<em class="orange">' + y + ".00</em>元（您的潮购币：" + t + "）")
				checkpay='fufen';
				banktype='nobank';
            } else {
                c.attr("sel", "0").attr("class", "z-pay-ment").next("span").html('潮购币支付<em class="orange">0.00</em>元（您的潮购币：' + t + "）")
            }
        };
        var f = function(y) {
        ...
        var u = function() { 
            ...
            if (w + g >= x) {			 
			    ...
			    if (shopnum != -1) {
					if (shopnum == 0) {
                                                location.replace(roots+"/payzg/paysubmitzg/type/"+checkpay+"/bank/"+banktype+"/sum/"+x+"/point/"+t)
					} else {
						if (shopnum == 1) {
							alert("亲，您的购物车中没有商品哦，去选购一些吧。");
							location.replace(roots+"/payzg/cartlistzg")
						} else {
							if (shopnum == 10) {
								location.reload()
							}
                ...
                if (e > 0) {
                    if (v == 1 || v == 2 || v == 3|| v == 4|| v == 5) {
                           ...
                           location.href = roots+"/Payzg/paysubmitzg/type/"+checkpay+"/bank/"+banktype+"/sum/"+x+"/point/"+t   
                    } 
                }
            }
        };
